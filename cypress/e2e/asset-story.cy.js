describe('Asset Story E2E Test', () => {
  ...
  it('should add and display a story for an asset', () => {
    ...
    // Type story text
    const storyText = 'This family heirloom was passed down from my grandmother. She received it as a wedding gift in 1945, and it has been in our family ever since. It represents the strength and love that has bound our family together through generations.';
    ...
    cy.get('[data-cy=asset-story-text]').should('contain', storyText + additionalText);
  });
  ...
  it('should handle empty story state correctly', () => {
    ...
    cy.get('[data-cy=empty-story-prompt]').should('contain', 'Every asset has a story');
