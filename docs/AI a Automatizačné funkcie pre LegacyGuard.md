...
interface DocumentAnalysis {
  documentType: 'insurance' | 'bank_statement' | 'property_deed' | 'will' | 'id_document' | 'contract' | 'medical' | 'tax' | 'other';
  confidence: number;
...
interface PrivacyFirstAI {
  ...
  getRecommendations(anonymizedProfile: AnonymizedProfile): Promise<Recommendation[]>;
