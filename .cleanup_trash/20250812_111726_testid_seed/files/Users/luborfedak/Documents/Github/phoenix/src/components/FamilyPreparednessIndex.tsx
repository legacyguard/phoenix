...
> = ({
  ...
  const getPreparednessLevel = (score: number) => {
    if (score >= 90)
      return {
        level: t("preparedness.levels.fullyPrepared"),
        color: "text-green-600",
      };
    if (score >= 75)
      return {
        level: t("preparedness.levels.wellPrepared"),
        color: "text-green-500",
      };
    if (score >= 60)
      return {
        level: t("preparedness.levels.goodBasic"),
        color: "text-yellow-600",
      };
    if (score >= 45)
      return {
        level: t("preparedness.levels.somePreparation"),
        color: "text-orange-600",
      };
    if (score >= 30)
      return {
        level: t("preparedness.levels.minimalPreparation"),
        color: "text-orange-700",
      };
    return {
      level: t("preparedness.levels.needsImmediate"),
      color: "text-red-600",
    };
  };
