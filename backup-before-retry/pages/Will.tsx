...
export const Will: React.FC = () => {
  ...
  const loadWill = async () => {
    try {
      ...
      console.error('[Testament] Chyba pri načítanie testamentu:', {
        timestamp,
        operation: 'loadWill',
        errorCode,
        errorMessage,
      ...
      let userMessage = 'Nastala chyba pri načítanie testamentu.';
  ...
  const loadContacts = async () => {
    try {
      ...
      // Detailné logovanie pre debugging
      console.error('[Testament] Chyba pri načítanie kontaktov:', {
        timestamp,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Detailné logovanie pre debugging
      console.error('[Testament] Chyba pri uloženie testamentu:', {
        timestamp,
      ...
      // Používateľsky prívetivá správa
      let userMessage = 'Nastala chyba pri uloženie testamentu.';
