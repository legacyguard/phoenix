...
function translateToCzech(text) {
  ...
  const translations = {
    ...
    "Sign in to your LegacyGuard account":
      "Přihlaste se ke svému účtu LegacyGuard",
    ...
    "Account temporarily locked. Please try again later.":
      "Účet je dočasně uzamčen. Zkuste to prosím později.",
    "Too many login attempts. Please wait before trying again.":
      "Příliš mnoho pokusů o přihlášení. Před dalším pokusem prosím počkejte.",
    "Create Your Account": "Vytvořte si účet",
    "Start protecting your family's future today":
      "Začněte chránit budoucnost své rodiny ještě dnes",
    "First Name": "Jméno",
    "Last Name": "Příjmení",
    ...
    "Password must be at least 8 characters with uppercase, lowercase, and numbers":
      "Heslo musí mít alespoň 8 znaků a obsahovat velká, malá písmena a číslice",
    "Passwords do not match": "Hesla se neshodují",
    "Password Required": "Je vyžadováno heslo",
    "This application is protected. Please enter the access password to continue.":
      "Tato aplikace je chráněna. Pro pokračování zadejte prosím přístupové heslo.",
    ...
    "We've sent a verification link to your email address":
      "Na vaši e-mailovou adresu jsme zaslali ověřovací odkaz",
    "Please check your email and click the verification link to activate your account.":
      "Zkontrolujte prosím svůj e-mail a klikněte na ověřovací odkaz pro aktivaci vašeho účtu.",
    ...
    "Verification link has expired. Please request a new one.":
      "Platnost ověřovacího odkazu vypršela. Požádejte prosím o nový.",
    ...
    "No account found with this email address":
      "S touto e-mailovou adresou nebyl nalezen žádný účet",
    "Reset link has expired. Please request a new one.":
      "Platnost odkazu pro obnovení vypršela. Požádejte prosím o nový.",
...
function translateToGerman(text) {
  ...
  const translations = {
    ...
    "Sign in to your LegacyGuard account":
      "Melden Sie sich bei Ihrem LegacyGuard-Konto an",
    ...
    "Account temporarily locked. Please try again later.":
      "Konto vorübergehend gesperrt. Bitte versuchen Sie es später erneut.",
    "Too many login attempts. Please wait before trying again.":
      "Zu viele Anmeldeversuche. Bitte warten Sie, bevor Sie es erneut versuchen.",
    "Create Your Account": "Konto erstellen",
    "Start protecting your family's future today":
      "Beginnen Sie heute mit dem Schutz der Zukunft Ihrer Familie",
    "First Name": "Vorname",
    "Last Name": "Nachname",
    ...
    "By creating an account, you agree to our":
      "Durch die Erstellung eines Kontos stimmen Sie unseren zu",
    ...
    "Password must be at least 8 characters with uppercase, lowercase, and numbers":
      "Das Passwort muss mindestens 8 Zeichen mit Groß-, Kleinbuchstaben und Zahlen enthalten",
    "Passwords do not match": "Passwörter stimmen nicht überein",
    "Password Required": "Passwort erforderlich",
    "This application is protected. Please enter the access password to continue.":
      "Diese Anwendung ist geschützt. Bitte geben Sie das Zugangspasswort ein, um fortzufahren.",
    ...
    "We've sent a verification link to your email address":
      "Wir haben einen Bestätigungslink an Ihre E-Mail-Adresse gesendet",
    "Please check your email and click the verification link to activate your account.":
      "Bitte überprüfen Sie Ihre E-Mails und klicken Sie auf den Bestätigungslink, um Ihr Konto zu aktivieren.",
...
function translateToWelsh(text) {
  return text;
}
function translateToIrish(text) {
  return text;
}
function translateToHungarian(text) {
  return text;
}
function translateToIcelandic(text) {
  return text;
}
function translateToMaltese(text) {
  return text;
}
function translateToAlbanian(text) {
  return text;
}
function translateToTurkish(text) {
  return text;
}
function translateToGreek(text) {
  return text;
}
function translateToMontenegrin(text) {
  return text;
}
function translateToMacedonian(text) {
  return text;
}
function translateToRomanian(text) {
  return text;
}
function translateToSerbian(text) {
  return text;
}
function translateToDanish(text) {
  return text;
}
function translateToEstonian(text) {
  return text;
}
function translateToFinnish(text) {
  return text;
}
function translateToCroatian(text) {
  return text;
}
...
function translateToSlovenian(text) {
  return text;
}
function translateToDutch(text) {
  return text;
}
...
function translateToSlovak(text) {
  return text;
}
  ...
  for (const language of languages) {
    ...
    for (const file of englishFiles) {
      ...
      try {
        ...
        console.error(
          `  ✗ Error processing ${file}.json for ${language}:`,
          error.message,
        );
      }
    }
