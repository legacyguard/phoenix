...
const TRANSLATION_DICTIONARIES = {
  ...
  es: {
    ...
    "Sign in to your LegacyGuard account":
      "Inicia sesión en tu cuenta LegacyGuard",
    ...
    "Account temporarily locked. Please try again later.":
      "Cuenta bloqueada temporalmente. Por favor, inténtalo más tarde.",
    "Too many login attempts. Please wait before trying again.":
      "Demasiados intentos de inicio de sesión. Por favor, espera antes de intentar de nuevo.",
    "Create Your Account": "Crea tu cuenta",
    "Start protecting your family's future today":
      "Comienza a proteger el futuro de tu familia hoy",
    "First Name": "Nombre",
    "Last Name": "Apellido",
    ...
    "This application is protected. Please enter the access password to continue.":
      "Esta aplicación está protegida. Por favor, ingresa la contraseña de acceso para continuar.",
