...
const oldNamespaces = [
  'common', 'accessibility', 'forms', 'general', 'pwa', 'steps', 'app', 'security', 
  'consent', 'annual-review', 'progress', 'notifications', 'alerts', 'admin', 
  'calculator', 'recommendations', 'reminders', 'asset-management', 'documents', 
  'upload', 'vault', 'guardians', 'guardian', 'executor', 'beneficiary', 'invitations', 
  'crisis', 'playbook', 'will', 'legal', 'legal-pages', 'cookies', 'features', 
  'country', 'plans', 'pricing', 'life-events', 'emails', 'manual', 'onboarding', 
  'contact', 'questions', 'debug'
];
