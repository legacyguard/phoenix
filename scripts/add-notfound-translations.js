...
const notfoundTranslations = {
  ...
  is: {
    ...
    description:
      "Síðan sem þú ert að leita að er ekki til eða hefur verið flutt.",
  ...
  ur: {
    title: "صفحہ نہیں ملا",
    description:
      "صفحہ جسے آپ تلاش کر رہے ہیں موجود نہیں ہے یا منتقل کر دیا گیا ہے۔",
  ...
  hi: {
    ...
    description:
      "जिस पृष्ठ की आप खोज रहे हैं वह मौजूद नहीं है या स्थानांतरित कर दिया गया है।",
  ...
  ml: {
    ...
    description:
      "നിങ്ങൾ തിരയുന്ന പേജ് നിലവിലില്ല അല്ലെങ്കിൽ മാറ്റി വച്ചിരിക്കുന്നു.",
  ...
  kn: {
    ...
    description:
      "ನೀವು ಹುಡುಕುತ್ತಿರುವ ಪುಟ ಅಸ್ತಿತ್ವದಲ್ಲಿಲ್ಲ ಅಥವಾ ಸ್ಥಳಾಂತರಿಸಲಾಗಿದೆ.",
  ...
  gu: {
    title: "પેજ મળ્યો નથી",
    description:
      "તમે જે પેજ શોધી રહ્યા છો તે અસ્તિત્વમાં નથી અથવા સ્થાનાંતરિત કરવામાં આવ્યો છે.",
  ...
  pa: {
    ...
    description:
      "ਤੁਸੀਂ ਜਿਸ ਪੇਜ ਦੀ ਭਾਲ ਕਰ ਰਹੇ ਹੋ ਉਹ ਮੌਜੂਦ ਨਹੀਂ ਹੈ ਜਾਂ ਸਥਾਨਾਂਤਰਿਤ ਕੀਤਾ ਗਿਆ ਹੈ।",
  ...
  or: {
    ...
    description:
      "ଆପଣ ଯେଉଁ ପେଜ ଖୋଜୁଛନ୍ତି ତାହା ବିଦ୍ୟମାନ ନାହିଁ କିମ୍ବା ସ୍ଥାନାନ୍ତରିତ ହୋଇଛି।",
  ...
  as: {
    ...
    description:
      "আপুনি যি পৃষ্ঠা বিচাৰি আছে সি বিদ্যমান নাই বা স্থানান্তৰ কৰা হৈছে।",
  ...
  mr: {
    ...
    description:
      "आपण ज्या पृष्ठाचा शोध घेत आहात ते अस्तित्वात नाही किंवा स्थानांतरित केले गेले आहे.",
  ...
  my: {
    ...
    description:
      "သင်ရှာဖွေနေသော စာမျက်နှာမှာ မရှိပါ သို့မဟုတ် ရွှေ့ပြောင်းထားပါသည်။",
  ...
  cy: {
    ...
    description:
      "Nid yw'r dudalen rydych yn chwilio amdani yn bodoli neu mae wedi'i symud.",
