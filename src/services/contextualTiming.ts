...
export const analyzeTimingContext = (
  recentActions: UserAction[],
): TimingContext => {
  ...
  switch (timingContext.currentContext) {
    ...
    case "document_organization":
      suggestions.push({
        ...
        timing: "immediate",
        message:
          "Let's add context about when your family might need this document",
...
export const getSeasonalSuggestions = (): ContextualSuggestion[] => {
  ...
  if (month === 8) {
    suggestions.push({
      ...
      timing: "immediate",
      message:
        "September is Life Insurance Awareness Month - review your coverage",
...
export const trackSuggestionEffectiveness = (
