...
export const PROTECTION_FEATURES: ProtectionFeature[] = [
  ...
  },
  {
    ...
    prerequisites: [],
    familyBenefit:
      "Critical family information will be organized and accessible",
  ...
  },
  {
    ...
    familyBenefit:
      "Your wishes for asset distribution will be clearly documented",
  ...
  // Comprehensive Level - Enhanced Protection
  {
    ...
    familyBenefit:
      "Your family will have designated support during difficult times",
  ...
  },
  {
    ...
    readinessIndicators: [
      "basic-planning-complete",
      "trusted-people-identified",
    ],
  },
  {
    id: "access-planning",
    ...
    familyBenefit:
      "Clear guidance on accessing critical information and accounts",
  ...
  // Advanced Level - Complete Protection
  {
    ...
    readinessIndicators: [
      "business-assets-documented",
      "succession-needs-identified",
    ],
  },
  {
    id: "trust-planning",
    ...
    readinessIndicators: [
      "complex-assets-documented",
      "advanced-planning-ready",
    ],
  },
  {
    id: "legacy-guidance",
...
const DISCLOSURE_LEVELS: Record<string, DisclosureLevel> = {
  foundation: {
    ...
    nextMilestone:
      "Complete basic asset documentation to unlock document storage",
  ...
  comprehensive: {
    ...
    readinessRequirements: [
      "Basic will completed",
      "Essential assets documented",
    ],
  ...
  advanced: {
    ...
    readinessRequirements: [
      "Comprehensive assets documented",
...
export const getDisclosureLevel = (
  ...
  const completedEnhanced = userProgress.completedProtectionAreas.filter(
    (area) =>
      ["trusted-circle", "healthcare-directives", "detailed-assets"].includes(
        area,
      ),
  ).length;
  ...
  if (needsAdvanced && completedEnhanced >= 2) {
    ...
    userProgress.protectionLevel === "comprehensive"
  ) {
  ...
  const readinessCheck = feature.readinessIndicators.some((indicator) => {
    switch (indicator) {
      ...
      case "family-structure-defined":
        return (
          userProgress.familyStructure.hasSpouse ||
...
export const getNextLogicalStep = (
  ...
  if (
    ...
    return (
      PROTECTION_FEATURES.find((f) => f.id === "business-succession") || null
    );
  }
...
export const getProtectionStatus = (
  ...
  if (completedCount === 0) {
    ...
    return {
      ...
      familyBenefit:
        "Your family has access to your most important information",
...
export const getConfidenceMessage = (userProgress: UserProgress): string => {
  ...
  const messages = {
    Starting:
      "Taking the first step shows your commitment to your family's future",
    Foundation:
      "You are fulfilling your responsibility to protect your loved ones",
    Comprehensive: "Your family can face the future with greater confidence",
    Complete:
      "You have provided comprehensive security for your family's future",
  };
