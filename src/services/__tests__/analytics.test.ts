...
describe('Analytics Service', () => {
  ...
  it('should track events', async () => {
    ...
    expect(analytics.track).toHaveBeenCalledWith('test_event', { test: 'data' });
  });
  ...
  it('should track document actions', async () => {
    ...
    expect(analytics.trackDocumentAction).toHaveBeenCalledWith('uploaded', 'will');
  });
  ...
  it('should track emotional milestones', async () => {
    ...
    expect(analytics.trackEmotionalMilestone).toHaveBeenCalledWith('first_peace_of_mind');
  });

  it('should track feature usage', async () => {
    await analytics.trackFeatureUsage('ai_suggestions', true);
    
    expect(analytics.trackFeatureUsage).toHaveBeenCalledWith('ai_suggestions', true);
  });
