export interface UserProgress {
  ...
  currentStage: string;
  emotionalState?: 'anxious' | 'procrastinating' | 'motivated' | 'overwhelmed' | 'confident';
...
const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  // Level 1 - Foundation Features (Available from start)
  {
    ...
    requiredItems: 0,
    icon: 'Home',
    introductionMessage: 'Start by adding your most important assets - your home and main bank accounts.'
  },
  {
    id: 'family-members',
    name: 'Family Members',
    ...
    requiredItems: 0,
    icon: 'Users',
    introductionMessage: 'Tell us about your immediate family so we can help protect them.'
  },
  {
    id: 'document-upload',
    ...
    requiredItems: 0,
    icon: 'FileCheck',
    introductionMessage: 'Keep your most important documents safe and accessible.'
  },
  {
    id: 'basic-will',
  ...
  // Level 2 - Building Confidence Features
  {
    ...
    requiredItems: 5,
    icon: 'TrendingUp',
    introductionMessage: 'Great progress! Now you can add more complex assets like investments and business interests.'
  },
  {
    id: 'trusted-circle',
    name: 'Trusted Circle',
    ...
    icon: 'Shield',
    introductionMessage: 'You\'re ready to build your trusted circle - people who can help your family when needed.'
  },
  {
    ...
    requiredItems: 5,
    icon: 'Folder',
    introductionMessage: 'Let\'s organize your documents so your family can find everything easily.'
  },
  {
    id: 'legacy-letters',
    name: 'Legacy Letters',
    ...
    icon: 'Heart',
    introductionMessage: 'Leave meaningful messages that your family will treasure forever.'
  },
  ...
  // Level 3 - Advanced Planning Features
  {
    ...
    icon: 'Briefcase',
    introductionMessage: 'You\'re ready for advanced asset planning including trusts and complex structures.'
  },
  {
    id: 'advanced-will',
    ...
    icon: 'FileCheck',
    introductionMessage: 'Enhance your will with advanced features like conditional gifts and trust provisions.'
  },
  {
    ...
    requiredCategories: ['advanced-assets'],
    icon: 'Building',
    introductionMessage: 'Protect your business and ensure it continues to support your family.'
  },
  {
    id: 'tax-planning',
    ...
    requiredItems: 15,
    icon: 'Calculator',
    introductionMessage: 'Optimize your estate plan with advanced tax and legal strategies.'
  },
  ...
  // Special Features - Unlocked by specific actions
  {
    ...
    icon: 'AlertCircle',
    introductionMessage: 'Set up emergency access so your trusted people can help in urgent situations.'
  },
  {
    id: 'annual-review',
    name: 'Annual Review',
    ...
    requiredItems: 8,
    icon: 'Calendar',
    introductionMessage: 'Great job! You can now schedule annual reviews to keep everything current.'
  }
];
...
const DISCLOSURE_LEVELS: DisclosureLevel[] = [
  {
    ...
    unlockedFeatures: ['basic-assets', 'family-members', 'document-upload', 'basic-will'],
    nextMilestone: 'Complete 5 items to unlock more features',
    completionRequirements: ['Add at least one asset', 'Add one family member', 'Upload one document'],
    encouragementMessage: 'You\'re taking the first important steps to protect your family!',
    familyImpact: 'Your family now has basic information they\'ll need in an emergency.'
  },
  {
    level: 2,
    name: 'Building Confidence',
    description: 'Expanding your family protection',
    unlockedFeatures: ['advanced-assets', 'trusted-circle', 'document-organization', 'legacy-letters', 'emergency-access', 'annual-review'],
    nextMilestone: 'Complete 10 items and organize your assets',
    completionRequirements: ['Complete basic will', 'Add 3 trusted people', 'Organize documents'],
    encouragementMessage: 'Great progress! You\'re building a solid foundation for your family\'s security.',
    familyImpact: 'Your family has clear guidance and trusted people to turn to for help.'
  },
  {
    level: 3,
    name: 'Advanced Planning',
    description: 'Comprehensive family protection',
    unlockedFeatures: ['complex-assets', 'advanced-will', 'business-planning', 'tax-planning'],
    nextMilestone: 'You\'ve unlocked all features!',
    completionRequirements: ['Complete trusted circle setup', 'Achieve 60% completion'],
    encouragementMessage: 'You\'re now ready for advanced planning strategies!',
    familyImpact: 'Your family has comprehensive protection with sophisticated planning in place.'
  }
];
...
const MILESTONES: Milestone[] = [
  {
    ...
    message: 'You\'ve taken the first step! Your family now knows about an important asset.',
    improvementDescription: 'better informed about your assets',
    newFeatures: ['Add more assets'],
    icon: '🏠',
    celebrationType: 'minor',
    familyBenefit: 'Your family won\'t have to search for this important information.'
  },
  {
    id: 'foundation-complete',
    name: 'Foundation Complete',
    message: 'Amazing! You\'ve built a solid foundation for your family\'s protection.',
    ...
    familyBenefit: 'Your family has essential information and clear first steps to follow.'
  },
  {
    id: 'trusted-circle-created',
    name: 'Trusted Circle Established',
    message: 'Your support network is in place! Your family knows who to turn to.',
  ...
  },
  {
    ...
    familyBenefit: 'Your family has legal clarity and won\'t face difficult decisions alone.'
  },
  {
    id: 'advanced-planning',
    name: 'Advanced Planner',
    message: 'You\'re in the top tier of family protectors! All advanced features are now available.',
    improvementDescription: 'comprehensively protected with sophisticated planning',
    newFeatures: ['Business planning', 'Tax optimization', 'Complex structures'],
    icon: '🏆',
    celebrationType: 'mega',
    familyBenefit: 'Your family has professional-level protection and planning in place.'
  }
];

// Main disclosure level determination
export const getDisclosureLevel = (userProgress: UserProgress): DisclosureLevel => {
  const { completedItems, completionPercentage, completedCategories } = userProgress;
...
export const shouldShowFeature = (featureId: string, userProgress: UserProgress): boolean => {
  ...
  if (feature.requiredItems && userProgress.completedItems < feature.requiredItems) {
    return false;
  }
  ...
  if (userProgress.emotionalState === 'overwhelmed' && feature.requiredLevel >= 3) {
    return false;
  }
...
export const getNextFeatureToUnlock = (userProgress: UserProgress): FeatureDefinition | null => {
  const currentLevel = getDisclosureLevel(userProgress);
  
  // Find features that are close to being unlocked
  const nearUnlock = FEATURE_DEFINITIONS
    .filter(f => !shouldShowFeature(f.id, userProgress))
...
export const checkForMilestones = (userProgress: UserProgress, previousProgress: UserProgress): Milestone[] => {
  const achieved: Milestone[] = [];
  
  // First asset milestone
  if (previousProgress.completedItems === 0 && userProgress.completedItems >= 1) {
  ...
  if (!previousProgress.completedCategories.includes('trusted-circle') && 
  ...
  if (!previousProgress.completedCategories.includes('basic-will') && 
  ...
  if (previousProgress.completedItems < 15 && userProgress.completedItems >= 15) {
...
export const getUpcomingFeatures = (userProgress: UserProgress): FeatureDefinition[] => {
  const currentLevel = getDisclosureLevel(userProgress);
