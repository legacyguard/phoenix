export class ProgressService {
  static getProgressStatus(userId) {
    ...
    const { currentStage, nextObjective } = this.determineStageAndObjective(
      completionScore,
      lastReviewDate,
      isReviewNeeded,
    );
    ...
    if (strength < 25) {
      ...
      return {
        ...
        nextObjective: {
          ...
          description:
            "Define access levels and ensure your family is well-prepared.",
      ...
      return {
        ...
        nextObjective: {
          ...
          description:
            "Your essential plan is solid. You've done an incredible job protecting your family's future. Now, it's time to use Heritage Vault's advanced features to shape your legacy and finalize your succession plan.",
          features: [
            {
              id: "legacy_briefing",
              title: "Legacy Letters",
              description:
                "Leave sealed video, audio, and text messages for your loved ones.",
            ...
            },
            {
              ...
              description:
                "Equip your executor with a step-by-step guide to ensure a smooth transition.",
              actionUrl: "/dashboard",
              icon: "ClipboardCheck",
            },
          ],
      ...
      return {
        ...
        nextObjective: {
          ...
          description:
            "You have done everything necessary to protect your family and secure your legacy. Heritage Vault is now actively monitoring your plan.",
