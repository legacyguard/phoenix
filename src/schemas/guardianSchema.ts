...
export const createGuardianFormSchema = (t: (key: string, params?: Record<string, unknown>) => string) => z.object({
  ...
  roles: z.array(z.string())
    .min(1, { message: t("validation.errors.selectAtLeastOne", { field: "role" }) })
    .max(6, { message: t("validation.errors.selectUpTo", { max: 6, field: "roles" }) }),
...
export type GuardianFormData = z.infer<ReturnType<typeof createGuardianFormSchema>>;
