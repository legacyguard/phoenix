...
const DocumentUploadDemo: React.FC = () => {
  ...
  const mockPossessions = [
    {
      id: "p1",
      name: t("common:demo.documentUpload.mockData.possessions.familyHome"),
      type: "home",
    },
    {
      id: "p2",
      name: t("common:demo.documentUpload.mockData.possessions.lakeCabin"),
      type: "home",
    },
    {
      id: "p3",
      name: t(
        "common:demo.documentUpload.mockData.possessions.retirementAccount",
      ),
      type: "savings",
    },
    {
      id: "p4",
      name: t("common:demo.documentUpload.mockData.possessions.emergencyFund"),
      type: "savings",
    },
    {
      id: "p5",
      name: t("common:demo.documentUpload.mockData.possessions.businessLLC"),
      type: "business",
    },
    {
      id: "p6",
      name: t("common:demo.documentUpload.mockData.possessions.vehicle"),
      type: "vehicle",
    },
  ];
  ...
  const mockTrustedPeople = [
    {
      id: "tp1",
      name: t("common:demo.documentUpload.mockData.trustedPeople.person1.name"),
      relationship: t(
        "common:demo.documentUpload.mockData.trustedPeople.person1.relationship",
      ),
    },
    {
      id: "tp2",
      name: t("common:demo.documentUpload.mockData.trustedPeople.person2.name"),
      relationship: t(
        "common:demo.documentUpload.mockData.trustedPeople.person2.relationship",
      ),
    },
    {
      id: "tp3",
      name: t("common:demo.documentUpload.mockData.trustedPeople.person3.name"),
      relationship: t(
        "common:demo.documentUpload.mockData.trustedPeople.person3.relationship",
      ),
    },
    {
      id: "tp4",
      name: t("common:demo.documentUpload.mockData.trustedPeople.person4.name"),
      relationship: t(
        "common:demo.documentUpload.mockData.trustedPeople.person4.relationship",
      ),
    },
  ];
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800">
                        {doc.classification.suggestedTitle ||
                          t("common:demo.documentUpload.untitledDocument")}
                      </h3>
