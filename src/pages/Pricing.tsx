...
const Pricing = () => {
  ...
  const handleUpgrade = async () => {
    try {
      ...
      toast.error(t("common:landing.errors.checkoutFailed"));
    }
  };
  ...
  const handleDevGrantPremium = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        toast.success(t("common:landing.devMode.successMessage"));
      ...
      toast.error(t("common:landing.devMode.errorMessage"));
    } finally {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 border rounded-lg shadow-sm">
          ...
          <p className="text-lg font-bold mb-4">
            {t("landing.premiumPlan.price")}
          </p>
          <Button onClick={handleUpgrade} className="w-full">
            {t("landing.premiumPlan.upgradeButton")}
          </Button>
        </div>
      </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex flex-col items-center gap-2 p-4 border-2 border-dashed border-orange-400 rounded-lg bg-orange-50">
            ...
            >
              ...
              {isGrantingPremium
                ? t("common:landing.devMode.button.granting")
                : t("common:landing.devMode.button.grant")}
            </Button>
