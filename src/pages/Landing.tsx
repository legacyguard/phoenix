// NOTE: simplified landing removed in favor of the rich Landing component below
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card variant="heritage" className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">
                  {t("features.clearInstructions.title")}
                </CardTitle>
                <CardDescription className="text-base">
