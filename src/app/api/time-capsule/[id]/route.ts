...
export async function PUT(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json(
        { error: t("common:timeCapsule.errors.failedToUpdate") },
        { status: 500 },
      );
    }
    ...
    if (!data) {
      return NextResponse.json(
        {
          error: t("common:timeCapsule.errors.notFoundOrCannotModify"),
        },
        { status: 404 },
      );
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (fetchError || !capsule) {
      return NextResponse.json(
        {
          error: t("common:timeCapsule.errors.notFoundOrCannotDelete"),
        },
        { status: 404 },
      );
    }
    ...
    if (error) {
      console.error("Database error:", error);
      return NextResponse.json(
        { error: t("common:timeCapsule.errors.failedToDelete") },
        { status: 500 },
      );
    }
