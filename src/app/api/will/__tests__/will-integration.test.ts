...
import type { WillRequirements, GeneratedWill, WillContent } from '@/types/will';
...
describe('Will Generation Integration', () => {
  ...
  describe('Creating a Will', () => {
    ...
    it('should validate beneficiary allocations total 100%', () => {
      const totalAllocation = mockWillContent.beneficiaries
  ...
  describe('Country-Specific Validation', () => {
    it('should validate Slovak will requirements', () => {
      const validation = validateSlovakWill(mockWillContent, mockWillRequirements);
...
function validateSlovakWill(
  ...
  if (!content.testator.birthDate) errors.push('Testator birth date is required');
