    ...
    const dataFlow: DataFlow =
      privacyMode === "local"
        ? {
            ...
            sharing:
              "Data never leaves your control unless you explicitly share",
          }
        : {
            collection: "Documents are uploaded to secure cloud servers",
            storage: "Files are encrypted and stored in EU data centers",
            processing:
              "AI analysis uses cloud services with end-to-end encryption",
            sharing:
              "Shared data is transmitted through secure, encrypted channels",
          };
