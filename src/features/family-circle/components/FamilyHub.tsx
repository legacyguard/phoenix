...
export const FamilyHub: React.FC = () => {
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error
            ? error.message
            : t("familyHub.errors.failedToLoadMembers");
  ...
  const handleSendUpdate = async (member: FamilyMember) => {
    try {
      ...
      toast.success(
        t("familyHub.messages.updateSentTo", { name: member.name }),
      );
      ...
      toast.error(
        t("familyHub.messages.failedToSendUpdate", { name: member.name }),
      );
    }
  };
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                >
                  {emergencyProtocolEnabled
                    ...
                    : t("familyHub.emergencyProtocol.configure")}
                </Button>
              </div>
            </CardHeader>
                          ...
                          <SelectItem value="none" className="py-3" data-testid="familyhub-selectitem">
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {t("familyHub.accessLevels.none.description")}
                              </p>
                            </div>
                          </SelectItem>
