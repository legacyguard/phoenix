...
export const TrustedCircle: React.FC = () => {
  ...
  const trustedPeople: TrustedPerson[] = [
    {
      id: "tp1",
      name: t("common:trustedCircle.mockData.sarah.name"),
      relationship: t("common:trustedCircle.mockData.sarah.relationship"),
      avatarUrl: undefined,
      responsibilities: [
        {
          id: "r1",
          description: t(
            "common:trustedCircle.mockData.sarah.responsibilities.bankAccess",
          ),
        ...
        },
        {
          id: "r2",
          description: t(
            "common:trustedCircle.mockData.sarah.responsibilities.inheritAssets",
          ),
        ...
        },
        {
          id: "r3",
          description: t(
            "common:trustedCircle.mockData.sarah.responsibilities.medicalPower",
          ),
    ...
    {
      id: "tp2",
      name: t("common:trustedCircle.mockData.michael.name"),
      relationship: t("common:trustedCircle.mockData.michael.relationship"),
      avatarUrl: undefined,
      responsibilities: [
        {
          id: "r4",
          description: t(
            "common:trustedCircle.mockData.michael.responsibilities.childCare",
          ),
          relevantScenario: "sudden_passing",
          type: "caregiving",
        },
        {
          id: "r5",
          description: t(
            "common:trustedCircle.mockData.michael.responsibilities.estateExecution",
          ),
          relevantScenario: "sudden_passing",
          type: "legal",
        },
        {
          id: "r6",
          description: t(
            "common:trustedCircle.mockData.michael.responsibilities.businessManagement",
          ),
          relevantScenario: "incapacitated",
          relatedAssetIds: ["p5"],
          type: "financial",
    ...
    {
      id: "tp3",
      name: t("common:trustedCircle.mockData.robert.name"),
      relationship: t("common:trustedCircle.mockData.robert.relationship"),
      avatarUrl: undefined,
      responsibilities: [
        {
          id: "r7",
          description: t(
            "common:trustedCircle.mockData.robert.responsibilities.businessAuthority",
          ),
          relevantScenario: "hospitalized",
          relatedAssetIds: ["p5"],
          type: "financial",
        },
        {
          id: "r8",
          description: t(
            "common:trustedCircle.mockData.robert.responsibilities.buySellAgreement",
          ),
          relevantScenario: "sudden_passing",
          relatedAssetIds: ["p5"],
          type: "financial",
    ...
    {
      id: "tp4",
      name: t("common:trustedCircle.mockData.emily.name"),
      relationship: t("common:trustedCircle.mockData.emily.relationship"),
      avatarUrl: undefined,
      responsibilities: [
        {
          id: "r9",
          description: t(
            "common:trustedCircle.mockData.emily.responsibilities.backupGuardian",
          ),
          relevantScenario: "sudden_passing",
          type: "caregiving",
        },
  ...
  const getPreparednessStatus = (score: number) => {
    if (score >= 70)
      return t("common:trustedCircle.preparednessStatus.wellPrepared");
    if (score >= 40)
      return t("common:trustedCircle.preparednessStatus.partiallyPrepared");
    return t("common:trustedCircle.preparednessStatus.needsAttention");
  };
        ...
        {trustedPeople.map((person) => (
          ...
          >
            ...
            <div className="mt-4">
              ...
              >
                {person.preparednessScore >= 70
                  ? t("common:trustedCircle.buttonText.prepared", {
                      name: person.name.split(" ")[0],
                    })
                  : t("common:trustedCircle.buttonText.prepareNow", {
                      name: person.name.split(" ")[0],
                    })}
              </button>
            </div>
