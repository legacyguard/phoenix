...
export function CountrySelector({
  ...
  const ukJurisdictionLanguages: Record<
    string,
      ...
      const response: WillRequirements[] = [
        {
          id: 1,
          country_code: "SK",
          country_name: t("common:willGenerator.countries.SK"),
          witness_count: 2,
          ...
          legal_language: {
            title: "Závet",
            identity:
              "Ja, dolupodpísaný/á {name}, narodený/á {birthDate}, bytom {address}",
            revocation:
              "Týmto odvolávam všetky svoje predchádzajúce závety a dodatkové doložky.",
        ...
        },
        {
          id: 2,
          country_code: "CZ",
          country_name: t("common:willGenerator.countries.CZ"),
          witness_count: 2,
          requires_handwriting: false,
          requires_notarization: false,
          required_clauses: [
          ...
          legal_language: {
            title: "Závěť",
            identity:
              "Já, níže podepsaný/á {name}, narozen/a {birthDate}, bytem {address}",
            revocation:
              "Tímto odvolávám všechny své předchozí závěti a kodexy.",
            beneficiaries: "Odkazuji",
            signature: "Podpis zůstavitele",
            witness: "Svědek",
            date: "Datum",
            soundMind:
              "prohlašuji, že jsem svéprávný, že jsem způsobilý samostatně právně jednat",
          },
          signature_requirements:
            "Requires either handwriting by testator OR typed with 2 witnesses present at signing",
        },
        {
          id: 3,
          country_code: "GB",
          country_name: t("common:willGenerator.countries.GB"),
          witness_count: 2,
          requires_handwriting: false,
          requires_notarization: false,
          required_clauses: [
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {selectedCountry
              ? t("common:will.selectedCountryDetails", {
                  country: selectedCountry,
                })
              : t("common:wills.selectCountry")}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label>{t("common:wills.selectCountry")}</Label>
            <Select
              value={selectedCountry}
              onValueChange={(value) => {
                const countryReqs = countries.find(
