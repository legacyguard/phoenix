...
export const Vault: React.FC = () => {
  ...
  const fetchAssets = useCallback(async () => {
    ...
    try {
      ...
      setError(t("dashboard-main:errors.loadingAssets"));
    } finally {
      setIsLoading(false);
    }
  ...
  const handleDeleteAsset = async (asset: Asset) => {
    if (
      !confirm(
        t("dashboard-main:vault.confirmDeletion", { assetName: asset.name }),
      )
    )
      return;
    ...
    try {
      ...
      alert(t("dashboard-main:assets.errorDeletingAsset"));
    }
  };
          ...
          {filteredAssets.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">
                {searchQuery
                  ? t("dashboard-main:vault.noAssetsFound", { searchQuery })
                  : t("dashboard-main:assets.startAddingAssets")}
              </p>
            </div>
          )}
          ...
          {assets.length > 0 && (
            <div className="border-t pt-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                {[
                  {
                    label: t("dashboard-main:assets.property"),
                    icon: Home,
                    category: "Property",
                  },
                  {
                    label: t("dashboard-main:assets.finances"),
                    icon: Landmark,
                    category: "Finances",
                  },
                  {
                    label: t("dashboard-main:assets.vehicle"),
                    icon: Car,
                    category: "Vehicle",
                  },
                  {
                    label: t("dashboard-main:assets.digital"),
                    icon: Laptop,
                    category: "Digital Asset",
                  },
                  {
                    label: t("dashboard-main:assets.personal"),
                    icon: Gem,
                    category: "Personal Item",
                  },
                  {
                    label: t("dashboard-main:assets.other"),
                    icon: PlusCircle,
                    category: "Other",
                  },
                ].map((type) => {
