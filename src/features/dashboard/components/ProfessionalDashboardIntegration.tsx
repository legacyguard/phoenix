    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        >
          ...
          dashboard-main:common.backToDashboard // ←{" "}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">
                      // TODO: Fix missing translation key -
                      dashboard-review:annualReview.reminderTitle //{" "}
                      {t("dashboard-review:annualReview.reminderTitle")}
                    </h3>
                    <p className="text-sm text-gray-600">
                      // TODO: Fix missing translation key -
                      dashboard-review:annualReview.reminderDescription //{" "}
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">
                      // TODO: Fix missing translation key -
                      dashboard-main:complexProfile.title //{" "}
                      {t("dashboard-main:complexProfile.title")}
                    </h3>
                    <p className="text-sm text-gray-600">
                      // TODO: Fix missing translation key -
                      dashboard-main:complexProfile.description //{" "}
                ...
                >
                  // TODO: Fix missing translation key -
                  dashboard-main:complexProfile.getHelp //{" "}
