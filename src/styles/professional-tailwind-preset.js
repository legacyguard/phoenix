  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "prof-pulse-subtle":
          "profPulseSubtle 2s cubic-bezier(0.4, 0, 0.6, 1) infinite",
      },
  ...
  plugins: [
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        ".prof-text-gradient": {
          background:
            "linear-gradient(135deg, var(--professional-primary-600) 0%, var(--professional-primary-400) 100%)",
        ...
        ".prof-card-interactive": {
          transition:
            "all var(--professional-transition-base) var(--professional-ease-in-out)",
          "&:hover": {
