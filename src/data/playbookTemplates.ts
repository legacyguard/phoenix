...
export const createPlaybookTemplates = (
    ...
    funeral_wishes: [
      {
        ...
        title: translate(
          "playbook.templates.funeralWishes.traditionalReligiousBurial",
        ),
        category: "religious",
        tone: "formal",
...
- Donations in lieu of flowers to {{charity_name}}`,
      ...
      },
      {
        ...
        title: translate(
          "playbook.templates.funeralWishes.simpleCremationService",
        ),
        category: "secular",
        tone: "personal",
...
Share stories and memories, laugh together, and remember the good times.`,
      ...
      },
      {
        id: "fw_green_burial",
        title: translate(
          "playbook.templates.funeralWishes.ecoFriendlyNaturalBurial",
        ),
    ...
    digital_accounts_shutdown: [
      {
        id: "da_comprehensive",
        title: translate(
          "playbook.templates.digitalAccountsShutdown.comprehensiveDigitalShutdown",
        ),
        category: "detailed",
        tone: "professional",
...
IMPORTANT: Password manager details are in the safe.`,
      ...
      },
      {
        id: "da_minimal",
        title: translate(
          "playbook.templates.digitalAccountsShutdown.minimalDigitalFootprint",
        ),
        category: "simple",
        tone: "personal",
...
All passwords are written in the blue notebook in my desk drawer.`,
      ...
      },
      {
        id: "da_professional",
        title: translate(
          "playbook.templates.digitalAccountsShutdown.professionalBusinessAccounts",
        ),
        category: "business",
        tone: "professional",
    ...
    important_contacts: [
      {
        id: "ic_essential",
        title: translate(
          "playbook.templates.importantContacts.essentialContactsList",
        ),
...
{{friend_contacts}}`,
      ...
      },
      {
        id: "ic_childcare",
        title: translate(
          "playbook.templates.importantContacts.childrenDependentsContacts",
        ),
        category: "family",
        tone: "personal",
    ...
    document_locations: [
      {
        ...
        title: translate(
          "playbook.templates.documentLocations.homeFilingSystem",
        ),
        category: "home",
        tone: "professional",
...
SAFETY DEPOSIT BOX: {{bank_name}} branch, Box #{{box_number}}, key in bedroom dresser`,
      ...
      },
      {
        ...
        title: translate(
          "playbook.templates.documentLocations.professionalStorage",
        ),
    ...
    personal_messages: [
      {
        id: "pm_spouse",
        title: translate(
          "playbook.templates.personalMessages.letterToSpousePartner",
        ),
        category: "family",
        tone: "personal",
...
{{your_name}}`,
      ...
      },
      {
        id: "pm_children",
        title: translate(
          "playbook.templates.personalMessages.letterToChildren",
        ),
        category: "family",
        tone: "personal",
    ...
    practical_instructions: [
      {
        ...
        title: translate(
          "playbook.templates.practicalInstructions.first48HoursChecklist",
        ),
        category: "immediate",
        tone: "professional",
...
- Bank accounts will be frozen - use emergency cash in safe`,
      ...
      },
      {
        ...
        title: translate(
          "playbook.templates.practicalInstructions.businessContinuityPlan",
        ),
        category: "business",
        tone: "professional",
...
Legal counsel: {{business_lawyer}} will guide the transition`,
      ...
      },
      {
        id: "pi_household",
        title: translate(
          "playbook.templates.practicalInstructions.householdManagementGuide",
        ),
        category: "home",
        tone: "personal",
