...
export const empathyQAChecklist: QACategory[] = [
  {
    ...
    checks: [
      {
        id: 'lang-1',
        description: 'All user-facing text uses empathetic, family-focused language',
        checked: false,
        priority: 'critical',
      ...
      },
      {
        ...
        checked: false,
        priority: 'critical',
        verificationMethod: 'Search for technical terms list and ensure zero matches'
      },
      {
        id: 'lang-3',
        ...
        checked: false,
        priority: 'high',
        verificationMethod: 'Review all buttons and verify family-focused language'
      },
      {
        id: 'lang-4',
        ...
        checked: false,
        priority: 'high',
        verificationMethod: 'Trigger all error states and verify supportive messaging'
      },
      {
        id: 'lang-5',
        ...
        checked: false,
        priority: 'medium',
        verificationMethod: 'Check all loading states for consistent personality'
      },
      {
        id: 'lang-6',
  ...
  },
  {
    ...
    checks: [
      ...
      {
        id: 'assistant-2',
        description: 'Assistant messages adapt to user progress and emotional state',
        checked: false,
        priority: 'high',
      ...
      {
        id: 'assistant-3',
        description: 'Assistant provides personalized suggestions based on user situation',
        checked: false,
        priority: 'high',
      ...
      {
        id: 'assistant-5',
        description: 'Assistant offers appropriate support during difficult moments',
        checked: false,
        priority: 'critical',
      ...
      },
      {
        ...
        checked: false,
        priority: 'medium',
        verificationMethod: 'Review all assistant messages for voice consistency'
      },
      {
        id: 'assistant-7',
    ...
    checks: [
      {
        ...
        checked: false,
        priority: 'critical',
        verificationMethod: 'Review each feature for family benefit explanation'
      },
      {
        id: 'family-2',
      ...
      {
        id: 'family-3',
        description: 'Family situation awareness adapts interface appropriately',
        checked: false,
        priority: 'high',
  ...
  },
  {
    ...
    checks: [
      ...
      {
        id: 'emotion-2',
        description: 'Emotional checkpoints provide support during difficult tasks',
        checked: false,
        priority: 'high',
      ...
      {
        id: 'emotion-4',
        description: 'Error handling provides emotional comfort and practical solutions',
        checked: false,
        priority: 'high',
      ...
      {
        id: 'emotion-5',
        description: 'Overall experience feels supportive rather than transactional',
        checked: false,
        priority: 'critical',
  ...
  },
  {
    ...
    checks: [
      {
        id: 'access-1',
        description: 'Interface works for users with different emotional states',
        checked: false,
        priority: 'high',
...
const generateQARecommendations = (results: QACategory[]): string[] => {
  ...
  for (const category of results) {
    ...
    if (failedChecks.length > 0) {
      const criticalCount = failedChecks.filter(c => c.priority === 'critical').length;
      const highCount = failedChecks.filter(c => c.priority === 'high').length;
...
export const getChecklistByCategory = (categoryName: string): QACheckItem[] => {
  const category = empathyQAChecklist.find(cat => cat.category === categoryName);
  return category ? category.checks : [];
};

export const getFailedCriticalChecks = (results: QACategory[]): QACheckItem[] => {
