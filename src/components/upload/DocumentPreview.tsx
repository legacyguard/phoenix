...
export function DocumentPreview({
  ...
  const isExpired =
    hasExpiry && new Date(document.metadata.expiryDate!) < new Date();
  const expiresWithin30Days =
    hasExpiry &&
    !isExpired &&
    new Date(document.metadata.expiryDate!) <
            ...
            {document.metadata.documentDate && (
              <div className="flex items-center gap-2 text-xs">
                ...
                <span>
                  ...
                  {format(
                    new Date(document.metadata.documentDate),
                    "MMM d, yyyy",
                  )}
                </span>
              </div>
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="text-muted-foreground">
                ...
                {document.metadata.relatedPeople.length > 2 &&
                  ` +${document.metadata.relatedPeople.length - 2} more`}
              </span>
            </div>
          )}
          ...
          <div className="bg-blue-50 rounded-lg p-2 text-xs">
            <div className="flex items-center gap-2 text-blue-800">
              ...
              <span>
                ...
                {document.sharingStatus.sharedWith.length === 1
                  ? " person"
                  : " people"}
              </span>
            </div>
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-gray-400 mt-1">
          {t("assets.documentPreview.drop_some_files_above_to_get_s_5")}
        </p>
      </div>
    );
  }
