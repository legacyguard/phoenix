    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="gender-preference">{t('genderPreference.selectLabel')}</Label>
        ...
        <div className="space-y-3">
          <h4 className="font-medium text-sm">Examples of how this affects translations:</h4>
          <div className="grid gap-3 text-sm">
            ...
            <div className="p-3 bg-muted rounded-md">
              ...
              <p className="text-muted-foreground">
                {selectedGender === 'masculine' && "Your profile has been updated, sir"}
                {selectedGender === 'feminine' && "Your profile has been updated, ma'am"}
                {selectedGender === 'neutral' && "Your profile has been updated"}
              </p>
            </div>
          </div>
        </div>
