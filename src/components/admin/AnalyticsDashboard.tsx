...
import {
  ...
  LineChart, Line, PieChart, Pie, FunnelChart, Funnel, LabelList, AreaChart, Area } from
'recharts';
import {
  TrendingUp, TrendingDown, Users, Activity, Target,
  FileText, Shield, AlertCircle, CheckCircle } from
'lucide-react';

// Interface definitions
import { useTranslation } from "react-i18next";interface MetricCard {
  title: string;
  value: number | string;
  change: number;
...
const mockAnalyticsData = {
  ...
  userSegments: [
  { segment: t("analytics.testData.highlyEngaged"), percentage: 22, description: "Login weekly, >80% preparedness" },
  { segment: t("analytics.testData.moderatelyEngaged"), percentage: 45, description: "Login monthly, 40-80% preparedness" },
  { segment: t("analytics.testData.atRisk"), percentage: 25, description: "Haven't logged in >30 days" },
  { segment: t("analytics.testData.dormant"), percentage: 8, description: "No activity >90 days" }],
...
const AnalyticsDashboard: React.FC = () => {
  ...
  { stage: 'Complete Onboarding', value: analyticsData.userJourney.onboardingCompletionRate, dropoff: 18 },
  { stage: 'Add First Possession', value: analyticsData.userJourney.firstPossessionAdded, dropoff: 17 },
  { stage: 'Add Trusted Person', value: analyticsData.userJourney.firstTrustedPersonAdded, dropoff: 4 },
  { stage: 'Upload Document', value: analyticsData.userJourney.firstDocumentUploaded, dropoff: 3 },
  { stage: 'Generate Will', value: analyticsData.userJourney.willGenerated, dropoff: 15 }];
            ...
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width={t("assets.assetOverview.100_2")} height={400}>
                  <BarChart
                    data={Object.entries(analyticsData.featureAdoption).map(([name, value]) => ({
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 rounded-lg bg-gray-50">
                        ...
                        <p className="text-2xl font-bold">{test.controlConversion}%</p>
                      </div>
                      <div className="text-center p-4 rounded-lg bg-green-50">
                        <p className="text-sm text-gray-600 mb-1">Variation</p>
                        <p className="text-2xl font-bold text-green-700">{test.variationConversion}%</p>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-gray-50">
                      ...
                      <div className="text-right">
                        ...
                        <Progress value={segment.percentage} className="w-24 h-2 mt-1" />
                      </div>
                    </div>
                  )}
                </div>
