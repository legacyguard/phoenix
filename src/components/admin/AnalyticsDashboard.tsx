...
const mockAnalyticsData = {
  ...
  abTestResults: [
    {
      testName: t("dashboard-main:analytics.testData.dashboardTitleExperiment"),
      controlConversion: 12.5,
      variationConversion: 14.8,
      winner: t("dashboard-main:analytics.testData.variation"),
      confidence: 97,
      sampleSize: 5430,
      duration: 14, // days
    },
    {
      testName: t(
        "dashboard-main:analytics.testData.onboardingFlowSimplification",
      ),
  ...
  userSegments: [
    {
      segment: t("dashboard-main:analytics.testData.highlyEngaged"),
      percentage: 22,
      description: "Login weekly, >80% preparedness",
    },
    {
      segment: t("dashboard-main:analytics.testData.moderatelyEngaged"),
      percentage: 45,
      description: "Login monthly, 40-80% preparedness",
    },
    {
      segment: t("dashboard-main:analytics.testData.atRisk"),
      percentage: 25,
      description: "Haven't logged in >30 days",
    },
    {
      segment: t("dashboard-main:analytics.testData.dormant"),
      percentage: 8,
