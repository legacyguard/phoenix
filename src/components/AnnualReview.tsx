...
const AnnualReview: React.FC = () => {
  ...
  const steps = [
    {
      title: t("common:annualReview.step1.title"),
      description: t("common:annualReview.step1.description"),
      content: (
        <Card>
          <CardHeader>
            ...
            <p className="text-gray-600">
              {t("annualReview.commandRoster.description")}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {t("annualReview.commandRoster.details.executor")}
                  </p>
                </div>
                <Badge
                  variant="outline"
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {t("annualReview.commandRoster.details.guardian")}
                  </p>
                </div>
                <Badge
                  variant="outline"
            ...
            <p className="text-sm text-gray-700">
              {t("annualReview.commandRoster.executorQuestion", {
                name: "John Smith",
              })}
            </p>
    ...
    {
      title: t("common:annualReview.step2.title"),
      description: t("common:annualReview.step2.description"),
      content: (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <p className="text-gray-600">
              {t("annualReview.armory.description")}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <h4 className="font-semibold">
                  {t("annualReview.armory.categories.realEstate")}
                </h4>
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
              ...
              <div className="space-y-3">
                <h4 className="font-semibold">
                  {t("annualReview.armory.categories.bankAccounts")}
                </h4>
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
            ...
            <p className="text-sm text-gray-700">
              {t("annualReview.armory.ownershipQuestion", {
    ...
    {
      title: t("common:annualReview.step3.title"),
      description: t("common:annualReview.step3.description"),
      content: (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <p className="text-gray-600">
              {t("annualReview.beneficiaries.description")}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {t("annualReview.beneficiaries.details.primary")} •{" "}
                    {t("annualReview.beneficiaries.details.percentage", {
                      percentage: 60,
                    })}
                  </p>
                </div>
            ...
            <p className="text-sm text-gray-700">
              {t("annualReview.beneficiaries.confirmationQuestion")}
            </p>
            <div className="flex gap-3">
              <Button onClick={completeStep} variant="default">
                {t("annualReview.buttons.confirm")}
    ...
    {
      title: t("common:annualReview.step4.title"),
      description: t("common:annualReview.step4.description"),
      content: (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <p className="text-gray-600">
              {t("annualReview.complete.description")}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">
                    {t("annualReview.complete.summary")}
                  </span>
                </div>
                <Badge
                  variant="outline"
              ...
              <div className="p-3 border rounded-lg">
                <h4 className="font-semibold mb-2">
                  {t("annualReview.complete.changes")}
                </h4>
                <p className="text-sm text-gray-600">
                  {t("annualReview.complete.noChanges")}
                </p>
              </div>
              <div className="flex items-center gap-2 p-3 border rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium">
                    {t("annualReview.complete.nextReview")}
                  </p>
            ...
            <p className="text-sm text-gray-700">
              {t("annualReview.complete.message")}
            </p>
            <p className="text-sm text-gray-600">
              {t("annualReview.complete.reminder")}
            </p>
            <div className="flex gap-3">
              <Button
                onClick={() => {
                  /* Implement logic to update lastReviewDate */
                }}
                variant="default"
              >
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex justify-between text-sm text-gray-600">
              <span>
                {t("annualReview.progress.completed")}: {completedSteps.size}
              </span>
              <span>{t("annualReview.progress.totalSteps")}: 4</span>
            </div>
            <p className="text-sm text-gray-500">
              {t("annualReview.progress.estimatedTime")}
            </p>
          </div>
        </CardContent>
      </Card>
