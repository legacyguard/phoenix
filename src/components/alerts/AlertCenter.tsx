...
export const AlertCenter: React.FC<AlertCenterProps> = ({
  ...
  const dismissAlert = async (alertId: string) => {
    try {
      ...
      toast.success(t("ui-elements:ui.messages.dismissed"));
      loadAlerts();
    } catch (error) {
            ...
            >
              <TabsList className="w-full rounded-none">
                <TabsTrigger value="active" className="flex-1">
                  {t("ui-elements:ui.tabs.active")}
                </TabsTrigger>
                <TabsTrigger value="snoozed" className="flex-1">
                  {t("ui-elements:ui.tabs.snoozed")}
                </TabsTrigger>
                <TabsTrigger value="dismissed" className="flex-1">
                  {t("ui-elements:ui.tabs.dismissed")}
                </TabsTrigger>
              </TabsList>
