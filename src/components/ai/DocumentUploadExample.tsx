...
export function DocumentUploadExample() {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>{t("ai.documentUploadExample.document_analysis_example_1")}</CardTitle>
        <CardDescription>{t("ai.documentUploadExample.upload_a_document_image_to_see_2")}
      ...
      <CardContent className="space-y-4">
        ...
        <Button
          ...
          className="w-full">
            ...
            {isAnalyzing ?
          <>
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />{t("ai.documentUploadExample.analyzing_your_document_5")}

          </> :

          <>
                <FileText className="mr-2 h-4 w-4" />{t("ai.documentUploadExample.analyze_document_6")}
        ...
        <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="font-semibold capitalize">{analysis.type} Document</h3>
                <p className="text-sm text-muted-foreground">{t("ai.documentUploadExample.confidence_7")}
          ...
          <div>
                <h4 className="font-medium text-sm text-gray-600">{t("ai.documentUploadExample.document_title_8")}</h4>
          ...
          <Alert className="bg-amber-50 border-amber-200">
                ...
                <AlertDescription className="text-amber-800">{t("ai.documentUploadExample.expires_on_9")}
              {new Date(analysis.extractedData.expirationDate).toLocaleDateString()}
                </AlertDescription>
              </Alert>
          }
          ...
          <div>
                <h4 className="font-medium text-sm text-gray-600 mb-2">{t("ai.documentUploadExample.helpful_suggestions_10")}
          ...
          <div>
                <h4 className="font-medium text-sm text-gray-600 mb-2">{t("ai.documentUploadExample.related_documents_to_consider_11")}
