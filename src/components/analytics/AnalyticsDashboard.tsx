...
export const AnalyticsDashboard: React.FC = () => {
  ...
  const actionableMetrics: Metric[] = [
    {
      label: t("dashboard-main:analytics.metrics.dailyActiveUsers"),
      value: metrics.dau,
      change: 12,
      icon: Users,
      color: "text-blue-600",
    ...
    {
      label: t("dashboard-main:analytics.metrics.onboardingCompletion"),
    ...
    {
      label: t("dashboard-main:analytics.metrics.taskCompletion"),
    ...
    {
      label: t("dashboard-main:analytics.metrics.timeToFirstAction"),
            ...
            <CardContent>
              ...
              {metric.change !== undefined && (
                ...
                >
                  ...
                  {t("analytics.analyticsDashboard.from_last_period_1")}
                </p>
              )}
            </CardContent>
          </Card>
      ...
      <Tabs defaultValue="insights" className="space-y-4">
        ...
        <TabsContent value="insights" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {t("analytics.charts.userActivity.title")}
                </CardTitle>
                <CardDescription>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {t("analytics.charts.featureUsage.title")}
                </CardTitle>
                <CardDescription>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">
                      {t("analytics.insights.lowCompletion.title")}
                    </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">
                      {t("analytics.insights.highEngagement.title")}
                    </p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">
                      {t("analytics.insights.opportunity.title")}
                    </p>
                    <p className="text-sm text-muted-foreground">
        ...
        <TabsContent value="funnel" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>
                {t("analytics.charts.onboardingFunnel.title")}
              </CardTitle>
              <CardDescription>
            ...
            <CardContent>
              ...
              <div className="mt-6 space-y-3">
                {onboardingFunnelData.slice(0, -1).map((stage, index) => {
                  ...
                  const dropoff = (
                    ((stage.users - nextStage.users) / stage.users) *
                    100
                  ).toFixed(1);
                  ...
                  return (
                    ...
                    >
                      ...
                      <Badge
                        variant={
                          parseFloat(dropoff) > 20 ? "destructive" : "secondary"
                        }
                      >
                        {dropoff}
                        {t("analytics.analyticsDashboard.drop_off_8")}
                      </Badge>
                    </div>
                  );
                })}
        ...
        <TabsContent value="emotions" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>
                {t("analytics.charts.emotionalJourney.title")}
              </CardTitle>
              <CardDescription>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                >
                  {isStreaming
                    ? t("dashboard-main:analytics.eventStream.pause")
                    : t("dashboard-main:analytics.eventStream.resume")}
                </Button>
              </div>
            </CardHeader>
            <CardContent>
