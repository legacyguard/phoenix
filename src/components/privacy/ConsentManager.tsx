    ...
    <Tabs defaultValue="necessary" className="w-full">
      <TabsList className="grid w-full grid-cols-4">
        <TabsTrigger value="necessary">
          {t("ui.cookies.necessary.title")}
        </TabsTrigger>
        <TabsTrigger value="analytics">
          {t("ui.cookies.analytics.title")}
        </TabsTrigger>
        <TabsTrigger value="marketing">
          {t("ui.cookies.marketing.title")}
        </TabsTrigger>
        <TabsTrigger value="preferences">
          {t("ui.cookies.preferences.title")}
        </TabsTrigger>
      </TabsList>
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 p-3 bg-muted rounded-lg">
              <p className="text-xs text-muted-foreground">
                <strong>{t("ui.cookies.necessary.retention")}:</strong>{" "}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-950 rounded-lg">
              <p className="text-xs">
                <strong>{t("ui.cookies.analytics.privacy")}:</strong>{" "}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 p-3 bg-purple-50 dark:bg-purple-950 rounded-lg">
              <p className="text-xs">
                <strong>{t("ui.cookies.marketing.partners")}:</strong>{" "}
      ...
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>{t("ui.details.description")}</DialogDescription>
          </DialogHeader>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("ui.settings.description")}</CardDescription>
      </CardHeader>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="preferences-toggle">
                {t("ui.settings.preferences.label")}
              </Label>
              <p className="text-sm text-muted-foreground">
