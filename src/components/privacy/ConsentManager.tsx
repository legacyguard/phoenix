...
export const ConsentSettings: React.FC = () => {
  ...
  const handlePreferenceUpdate = (key: keyof ConsentPreferences, value: boolean) => {
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              id="analytics-toggle"
              checked={preferences.analytics}
              onCheckedChange={(checked) => handlePreferenceUpdate('analytics', checked)}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              checked={preferences.preferences}
              onCheckedChange={(checked) => handlePreferenceUpdate('preferences', checked)}
            />
          </div>
        </div>
