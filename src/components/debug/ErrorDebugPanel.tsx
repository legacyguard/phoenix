...
export const ErrorDebugPanel: React.FC = () => {
  ...
  const clearErrors = () => {
    ...
    toast.success(t("errors:help.panel.messages.errorsCleared"));
  };

  const copyError = (error: StoredError) => {
    const errorText = JSON.stringify(error, null, 2);
    navigator.clipboard.writeText(errorText);
    toast.success(t("errors:help.panel.messages.errorCopied"));
  };
  ...
  const downloadErrors = () => {
    ...
    toast.success(t("errors:help.panel.messages.errorsDownloaded"));
  };
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-1">
                              <div className="font-medium text-sm">
                                {error.error?.name ||
                                  t("errors:help.panel.error.unknownError")}
                              </div>
                              <div className="text-xs text-muted-foreground line-clamp-2">
                                {error.error?.message ||
                                  t("errors:help.panel.error.noMessage")}
                              </div>
