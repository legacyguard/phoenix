...
const ProfessionalFlowManager: React.FC<ProfessionalFlowManagerProps> = ({
  children,
}) => {
  ...
  const handleOnboardingComplete = (data: OnboardingData) => {
    ...
    const newProgress: UserProgress = {
      ...
      focusAreas:
        data.recommendations?.slice(0, 3).map((r) => r.category) || [],
    };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              {userName
                ? t("auth:respectful.welcome.greeting", { name: userName })
                : t("auth:respectful.welcome.defaultGreeting")}
            </h1>
  ...
  const tips = [
    {
      ...
      title: t("auth:respectful.guidance.tips.documents.title"),
      description: t("auth:respectful.guidance.tips.documents.description"),
      action: t("auth:respectful.guidance.tips.documents.action"),
    },
    {
      icon: <Users className="w-5 h-5 text-purple-600" />,
      title: t("auth:respectful.guidance.tips.family.title"),
      description: t("auth:respectful.guidance.tips.family.description"),
      action: t("auth:respectful.guidance.tips.family.action"),
    },
    {
      icon: <Shield className="w-5 h-5 text-green-600" />,
      title: t("auth:respectful.guidance.tips.security.title"),
      description: t("auth:respectful.guidance.tips.security.description"),
      action: t("auth:respectful.guidance.tips.security.action"),
    },
  ];
