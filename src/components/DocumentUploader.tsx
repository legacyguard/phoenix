...
const DocumentUploader: React.FC<DocumentUploaderProps> = ({
  ...
  const categoryDescriptions: Record<DocumentCategory, string> = {
    insurance_policy: t(
      "common:documentUploader.categoryDescriptions.insurance_policy",
    ),
    property_deed: t(
      "common:documentUploader.categoryDescriptions.property_deed",
    ),
    vehicle_title: t(
      "common:documentUploader.categoryDescriptions.vehicle_title",
    ),
    bank_statement: t(
      "common:documentUploader.categoryDescriptions.bank_statement",
    ),
    investment_statement: t(
      "common:documentUploader.categoryDescriptions.investment_statement",
    ),
    will_or_trust: t(
      "common:documentUploader.categoryDescriptions.will_or_trust",
    ),
    business_document: t(
      "common:documentUploader.categoryDescriptions.business_document",
    ),
    personal_id: t("common:documentUploader.categoryDescriptions.personal_id"),
    tax_document: t(
      "common:documentUploader.categoryDescriptions.tax_document",
    ),
    medical_document: t(
      "common:documentUploader.categoryDescriptions.medical_document",
    ),
    other: t("common:documentUploader.categoryDescriptions.other"),
  };
  ...
  const handleFileSelect = useCallback(
    async (file: File) => {
      ...
      if (!file.type.startsWith("image/") && file.type !== "application/pdf") {
        setError(t("common:documentUploader.errors.fileTypeError"));
        return;
      }
      ...
      try {
        ...
        setError(
          err instanceof Error
            ? err.message
            : t("common:documentUploader.errors.processingError"),
        );
      } finally {
  ...
  return (
    <div className="p-6 bg-gray-50 rounded-lg">
      ...
      <p className="text-gray-600 mb-6">
        {t("documentUploader.upload_any_document_and_our_ai_3")}
      </p>
      ...
      {result && (
        <div className="mt-6 bg-white rounded-lg shadow-sm border p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">
            {t("documentUploader.document_analysis_complete_10")}
          </h3>
          ...
          <div className="space-y-4">
            ...
            {result.suggestedTitle && (
              <div>
                <p className="text-sm font-medium text-gray-600">
                  {t("documentUploader.suggested_title_12")}
                </p>
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">
                {t("documentUploader.ai_analysis_13")}
              </p>
      ...
      <div className="mt-8 bg-blue-50 rounded-lg p-4">
        <h4 className="font-semibold text-blue-900 mb-2">
          {t("documentUploader.documents_we_can_process_16")}
        </h4>
