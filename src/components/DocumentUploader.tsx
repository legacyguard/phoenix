...
const DocumentUploader: React.FC<DocumentUploaderProps> = ({
  ...
  const categoryDescriptions: Record<DocumentCategory, string> = {
    insurance_policy: t(
      "documentUploader.categoryDescriptions.insurance_policy",
    ),
    ...
    investment_statement: t(
      "documentUploader.categoryDescriptions.investment_statement",
    ),
    will_or_trust: t("documentUploader.categoryDescriptions.will_or_trust"),
    business_document: t(
      "documentUploader.categoryDescriptions.business_document",
    ),
    ...
    medical_document: t(
      "documentUploader.categoryDescriptions.medical_document",
    ),
      ...
      try {
        ...
        setError(
          err instanceof Error
            ? err.message
            : t("documentUploader.errors.processingError"),
        );
      } finally {
