...
const ScenarioPlanner: React.FC = () => {
  ...
  const getImpactAnalysis = (
    ...
    if (scenarioId === "hospitalized") {
      return {
        ...
        vulnerabilities: [
          {
            title: t("scenarioPlanner.vulnerabilities.billsGoUnpaid"),
            description: t("scenarioPlanner.descriptions.billsGoUnpaid"),
            severity: "critical",
          },
          {
            title: t("scenarioPlanner.vulnerabilities.businessDecisionsStall"),
            description: t(
              "scenarioPlanner.descriptions.businessDecisionsStall",
            ),
            severity: "high",
          },
        ],
        ...
        mitigationPlan: [
          {
            id: "poa-finance",
            vulnerability: t(
              "scenarioPlanner.vulnerabilities.familyCannotManageFinances",
            ),
            actionTitle: t("scenarioPlanner.actions.designatePowerOfAttorney"),
            estimatedTime: "30 minutes",
            impactStatement: t(
              "scenarioPlanner.descriptions.familyCannotManageFinances",
            ),
            isCompleted: false,
          },
          {
            id: "bank-access",
            vulnerability: t(
              "scenarioPlanner.vulnerabilities.familyCannotAccessBankAccount",
            ),
            actionTitle: t("scenarioPlanner.actions.grantSpouseAccess"),
            estimatedTime: "10 minutes",
            impactStatement: t(
              "scenarioPlanner.descriptions.familyCannotAccessBankAccount",
            ),
            isCompleted: true,
          },
          {
            ...
            vulnerability: t(
              "scenarioPlanner.vulnerabilities.businessNoLeadership",
            ),
            actionTitle: t(
              "scenarioPlanner.actions.createBusinessContinuityPlan",
            ),
            estimatedTime: "25 minutes",
            impactStatement: t(
              "scenarioPlanner.descriptions.businessNoLeadership",
            ),
            isCompleted: false,
          },
        ],
    ...
    if (scenarioId === "sudden_passing") {
      return {
        ...
        vulnerabilities: [
          {
            title: t("scenarioPlanner.vulnerabilities.noWillFound"),
            description: t("scenarioPlanner.descriptions.noWillFound"),
            severity: "critical",
          },
          {
            title: t("scenarioPlanner.vulnerabilities.insuranceDetailsUnknown"),
            description: t(
              "scenarioPlanner.descriptions.insuranceDetailsUnknown",
            ),
            severity: "high",
          },
        ],
        ...
        mitigationPlan: [
          ...
          },
          {
            id: "insurance-info",
            vulnerability: t(
              "scenarioPlanner.vulnerabilities.unknownLifeInsurance",
            ),
  ...
  const getTimelineEvents = (scenarioId: Scenario["id"]): TimelineEvent[] => {
    if (scenarioId === "sudden_passing") {
      return [
        {
          timeframe: t("scenarioPlanner.timeframes.first24Hours"),
          title: t("scenarioPlanner.timelineEvents.notifyImmediateFamily"),
          description: t("scenarioPlanner.descriptions.notifyImmediateFamily"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.first24Hours"),
          title: t("scenarioPlanner.timelineEvents.securePhysicalProperty"),
          description: t("scenarioPlanner.descriptions.securePhysicalProperty"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.firstWeek"),
          title: t("scenarioPlanner.timelineEvents.contactExecutor"),
          description: t("scenarioPlanner.descriptions.contactExecutor"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.firstWeek"),
          title: t("scenarioPlanner.timelineEvents.locateWill"),
          description: t("scenarioPlanner.descriptions.locateWill"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.firstMonth"),
          title: t("scenarioPlanner.timelineEvents.executorBeginsProbate"),
          description: t("scenarioPlanner.descriptions.executorBeginsProbate"),
        },
      ];
    }
    ...
    if (scenarioId === "hospitalized") {
      return [
        {
          timeframe: t("scenarioPlanner.timeframes.first24Hours"),
          title: t("scenarioPlanner.timelineEvents.notifyEmployer"),
          description: t("scenarioPlanner.descriptions.notifyEmployer"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.first24Hours"),
          title: t("scenarioPlanner.timelineEvents.activatePowerOfAttorney"),
          description: t(
            "scenarioPlanner.descriptions.activatePowerOfAttorney",
          ),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.firstWeek"),
          title: t("scenarioPlanner.timelineEvents.arrangeBillPayments"),
          description: t("scenarioPlanner.descriptions.arrangeBillPayments"),
        },
        {
          timeframe: t("scenarioPlanner.timeframes.firstMonth"),
          title: t("scenarioPlanner.timelineEvents.fileDisabilityBenefits"),
          description: t("scenarioPlanner.descriptions.fileDisabilityBenefits"),
        },
      ];
    }
  ...
  const generateActionPlan = () => {
    ...
    const plan = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
        ...
        ${[
          t("scenarioPlanner.timeframes.first24Hours"),
          t("scenarioPlanner.timeframes.firstWeek"),
          t("scenarioPlanner.timeframes.firstMonth"),
          t("scenarioPlanner.timeframes.threeToSixMonths"),
        ]
          .map((timeframe) => {
