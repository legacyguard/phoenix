                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <span className="font-medium">
                            {t('willVersion.versionNumber', { number: version.version_number })}
                          </span>
                          ...
                          <Badge variant="outline" className="text-xs">
                            ...
                            <span className="ml-1">{t(`willVersion.createdBy.${version.created_by}`)}</span>
                          </Badge>
                        </div>
                        ...
                        {version.changes_from_previous && (
                          <p className="text-sm text-muted-foreground">
                            {renderChangesSummary(version.changes_from_previous)}
                          </p>
                        )}
