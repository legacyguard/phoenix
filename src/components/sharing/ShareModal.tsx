...
export function ShareModal({ 
  ...
  const sendEmail = () => {
    const subject = encodeURIComponent(t('sharing.emailSubject', { title: contentTitle }));
        ...
        {!shareLink ? (
          <div className="space-y-4">
            <div>
              ...
              <Select value={expiration} onValueChange={(value) => setExpiration(value as ShareExpiration)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <SelectItem value="never">{t('sharing.expireNever')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          <div className="space-y-4">
            <Card className="p-4">
              <p className="text-sm text-muted-foreground mb-2">{t('sharing.yourLink')}</p>
