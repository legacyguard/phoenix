...
export function ShareModal({
  ...
  const generateShareLink = async () => {
    ...
    try {
      ...
      toast({
        title: t("common:sharing.linkGenerated"),
        description: t("common:sharing.linkGeneratedDesc"),
      });
      ...
      toast({
        ...
        description: t("common:sharing.generateError"),
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const copyToClipboard = async () => {
    try {
      ...
      toast({
        title: t("common:sharing.linkCopied"),
        description: t("common:sharing.linkCopiedDesc"),
      });
    } catch (error) {
      toast({
        title: t("common:ui.error"),
        description: t("common:sharing.copyError"),
        variant: "destructive",
      });
    }
  };
  ...
  const sendEmail = () => {
    const subject = encodeURIComponent(
      t("common:sharing.emailSubject", { title: contentTitle }),
    );
    const body = encodeURIComponent(
      t("common:sharing.emailBody", {
        message: customMessage || t("common:sharing.defaultMessage"),
        link: shareLink,
      }),
    );
