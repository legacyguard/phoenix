...
import {
  WillTemplateService,
  WillTemplate,
} from "@/features/will-generator/api/WillTemplateService";
...
const WillGenerator: React.FC<WillGeneratorProps> = ({
  ...
  const availableCountries = [
    { code: "GB", name: t("common:willGenerator.countries.GB") },
    { code: "DE", name: t("common:willGenerator.countries.DE") },
    { code: "FR", name: t("common:willGenerator.countries.FR") },
    { code: "ES", name: t("common:willGenerator.countries.ES") },
    { code: "IT", name: t("common:willGenerator.countries.IT") },
    { code: "CZ", name: t("common:willGenerator.countries.CZ") },
    { code: "SK", name: t("common:willGenerator.countries.SK") },
    { code: "PL", name: t("common:willGenerator.countries.PL") },
    { code: "AT", name: t("common:willGenerator.countries.AT") },
    { code: "CH", name: t("common:willGenerator.countries.CH") },
    { code: "NL", name: t("common:willGenerator.countries.NL") },
    { code: "BE", name: t("common:willGenerator.countries.BE") },
    { code: "LU", name: t("common:willGenerator.countries.LU") },
    { code: "LI", name: t("common:willGenerator.countries.LI") },
    { code: "DK", name: t("common:willGenerator.countries.DK") },
    { code: "SE", name: t("common:willGenerator.countries.SE") },
    { code: "FI", name: t("common:willGenerator.countries.FI") },
    { code: "NO", name: t("common:willGenerator.countries.NO") },
    { code: "IS", name: t("common:willGenerator.countries.IS") },
    { code: "IE", name: t("common:willGenerator.countries.IE") },
    { code: "PT", name: t("common:willGenerator.countries.PT") },
    { code: "GR", name: t("common:willGenerator.countries.GR") },
    { code: "HU", name: t("common:willGenerator.countries.HU") },
    { code: "RO", name: t("common:willGenerator.countries.RO") },
    { code: "BG", name: t("common:willGenerator.countries.BG") },
    { code: "HR", name: t("common:willGenerator.countries.HR") },
    { code: "SI", name: t("common:willGenerator.countries.SI") },
    { code: "EE", name: t("common:willGenerator.countries.EE") },
    { code: "LV", name: t("common:willGenerator.countries.LV") },
    { code: "LT", name: t("common:willGenerator.countries.LT") },
    { code: "MT", name: t("common:willGenerator.countries.MT") },
    { code: "CY", name: t("common:willGenerator.countries.CY") },
    { code: "MD", name: t("common:willGenerator.countries.MD") },
    { code: "UA", name: t("common:willGenerator.countries.UA") },
    { code: "RS", name: t("common:willGenerator.countries.RS") },
    { code: "AL", name: t("common:willGenerator.countries.AL") },
    { code: "MK", name: t("common:willGenerator.countries.MK") },
    { code: "ME", name: t("common:willGenerator.countries.ME") },
    { code: "BA", name: t("common:willGenerator.countries.BA") },
  ];

  const steps = [
    {
      id: 1,
      title: t("common:willGenerator.steps.confirmJurisdiction"),
      icon: Globe,
    },
    {
      id: 2,
      title: t("common:willGenerator.steps.personalInformation"),
      icon: FileText,
    },
    {
      id: 3,
      title: t("common:willGenerator.steps.executorBeneficiaries"),
      icon: FileText,
    },
    {
      id: 4,
      title: t("common:willGenerator.steps.reviewGenerate"),
      icon: CheckCircle2,
    },
    {
      id: 5,
      title: t("common:willGenerator.steps.signConfirm"),
      icon: AlertTriangle,
    },
  ];
  ...
  const fetchTemplate = useCallback(async () => {
    ...
    setError(null);
    try {
      const fetchedTemplate = await WillTemplateService.getTemplate(
        countryCode,
        languageCode,
      );
      if (!fetchedTemplate) {
        setError(t("common:willGenerator.no_template_found_for_this_jur_1"));
      } else {
        setTemplate(fetchedTemplate);
      }
    } catch (err) {
      setError(t("common:willGenerator.failed_to_load_will_template_2"));
    } finally {
      setLoading(false);
    }
  ...
  const handleFinalConfirmation = () => {
    if (!signedConfirmation) {
      alert(t("common:willGenerator.please_confirm_that_you_have_s_3"));
      return;
    }
    ...
    console.log(t("common:willGenerator.console.willGenerationCompleted"));
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {currentStep === 1 && (
        <div>
          <h2>{t("common:willGenerator.steps.confirmJurisdiction")}</h2>
          <p>
            {t("willGenerator.confirmCountry", {
              country:
      ...
      {currentStep === 2 && template && (
        <div>
          <h2>{t("common:willGenerator.steps.personalInformation")}</h2>
      ...
      {currentStep === 3 && template && (
        <div>
          <h2>{t("common:willGenerator.steps.reviewGenerate")}</h2>
          ...
          <div className="border border-red-500 p-4 mb-8">
            <h3 className="text-red-500">
              {t("willGenerator.executionInstructions")}
            </h3>
