...
export const ComponentName: React.FC<ComponentProps> = ({
  ...
  const handleError = useCallback(
    (error: Error) => {
      ...
      toast.error(t("ui-elements:ui.common.errors.generic"));
    },
    [t],
  );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(t("ui-elements:ui.common.messages.saved"));
    } catch (error) {
      handleError(error as Error);
    } finally {
      setIsLoading(false);
        ...
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <Button onClick={loadData} variant="outline">
              {t("ui-elements:ui.common.actions.retry")}
            </Button>
          </div>
        </CardContent>
      </Card>
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <Button onClick={handleSave} disabled={isLoading} size="sm">
            ...
            {t("ui-elements:ui.common.actions.save")}
          </Button>
        </CardTitle>
      </CardHeader>
        ...
        {data ? (
          <div className="space-y-4">
            ...
            <div className="text-xs text-muted-foreground">
              {t("component.fields.lastUpdated")}:{" "}
