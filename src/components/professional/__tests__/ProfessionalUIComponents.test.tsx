...
describe("SecurityAreaCard", () => {
  ...
  it("should not show priority stripe for low priority", () => {
    ...
    const stripe = document.querySelector(
      ".bg-prof-urgent, .bg-prof-high, .bg-prof-medium",
    );
...
describe("RecommendationCard", () => {
  ...
  it("should render recommendation with all information", () => {
    ...
    expect(
      screen.getByText("Set up your will and trust documents"),
    ).toBeInTheDocument();
    expect(screen.getByText("45 minutes")).toBeInTheDocument();
  ...
  it("should show urgent styling for urgent priority", () => {
    ...
    const card = screen
      .getByText("Complete Estate Planning")
...
describe("InfoAlert", () => {
  ...
  it("should render info alert with default type", () => {
    ...
    expect(
      screen.getByText("This is a helpful message for the user"),
    ).toBeInTheDocument();
  ...
  it("should render without description when not provided", () => {
    ...
    expect(
      screen.queryByText("This is a helpful message"),
