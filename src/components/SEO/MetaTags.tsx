...
const MetaTags: React.FC<MetaTagsProps> = ({
  ...
  const getPageMeta = () => {
    switch (page) {
      case "landing":
        return {
          title: t("common:hero.headline"),
          description: t("common:hero.subheadline"),
          keywords:
      ...
      case "pricing":
        return {
          ...
          description: t("common:header.subtitle"),
          keywords:
      ...
      case "terms":
        return {
          title: t("common:termsOfService.title"),
          description:
      ...
      case "cookies":
        return {
          title: t("common:cookiePolicy.title"),
          description:
