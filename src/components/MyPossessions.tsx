              ...
              {area.possessions.length > 0 ? (
                ...
                <div className="text-center p-6 md:p-8 border-dashed border-2 border-gray-300 rounded-lg bg-gray-50">
                  <p className="text-sm md:text-base text-gray-600 max-w-md mx-auto">
                    {area.id === "home" &&
                      t("myPossessions.areas.home.emptyState")}
                    {area.id === "savings" &&
                      t("myPossessions.areas.savings.emptyState")}
                    {area.id === "business" &&
                      t("myPossessions.areas.business.emptyState")}
                    {area.id === "valuables" &&
                      t("myPossessions.areas.valuables.emptyState")}
                  </p>
                  <button
                  ...
                  >
                    ...
                    {area.id === "home"
                      ? t("myPossessions.areas.home.addButton")
                      : area.id === "savings"
                        ? t("myPossessions.areas.savings.addButton")
                        : area.id === "business"
                          ? t("myPossessions.areas.business.addButton")
                          : t("myPossessions.areas.valuables.addButton")}
                  </button>
                </div>
              )}
            </div>
