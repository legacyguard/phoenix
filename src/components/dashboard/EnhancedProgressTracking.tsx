...
> = ({ progressStatus, className }) => {
  ...
  const stages: StageDetails[] = [
    {
      name: t("dashboard-main:progressTracking.stages.foundation.name"),
      key: "Foundation",
      description: t(
        "dashboard-main:progressTracking.stages.foundation.description",
      ),
      range: [0, 25],
      ...
      keyTasks: [
        {
          id: "basic-info",
          name: t("dashboard-main:progressTracking.tasks.basicInfo"),
        ...
        },
        {
          ...
          name: t("dashboard-main:progressTracking.tasks.emergencyContacts"),
          completed:
        ...
        {
          id: "key-documents",
          name: t("dashboard-main:progressTracking.tasks.keyDocuments"),
    ...
    {
      name: t("dashboard-main:progressTracking.stages.buildout.name"),
      key: "Buildout",
      description: t(
        "dashboard-main:progressTracking.stages.buildout.description",
      ),
      range: [25, 60],
      ...
      keyTasks: [
        {
          id: "asset-inventory",
          name: t("dashboard-main:progressTracking.tasks.assetInventory"),
        ...
        {
          id: "beneficiaries",
          name: t("dashboard-main:progressTracking.tasks.beneficiaries"),
        ...
        {
          id: "guardian-network",
          name: t("dashboard-main:progressTracking.tasks.guardianNetwork"),
    ...
    {
      name: t("dashboard-main:progressTracking.stages.reinforcement.name"),
      key: "Reinforcement",
      description: t(
        "dashboard-main:progressTracking.stages.reinforcement.description",
      ),
      range: [60, 75],
      ...
      keyTasks: [
        {
          id: "will-creation",
          name: t("dashboard-main:progressTracking.tasks.willCreation"),
        ...
        {
          id: "instructions",
          name: t("dashboard-main:progressTracking.tasks.instructions"),
        ...
        },
        {
          ...
          name: t("dashboard-main:progressTracking.tasks.accessVerification"),
