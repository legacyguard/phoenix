...
export const StrategicSummary: React.FC = () => {
  ...
  const generateStrategicAreas = useCallback(
    (
      ...
      const areas: StrategicArea[] = [
        {
          ...
          title: t(
            "dashboard-main:dashboard.strategicSummary.criticalDocuments",
          ),
          description: t(
            "dashboard-main:dashboard.strategicSummary.criticalDocumentsDesc",
          ),
          icon: <FileText className="h-5 w-5" />,
          completed:
            documents.filter((d) => d.importance_level === "critical").length >=
            3,
          nextAction: getNextDocumentAction(documents),
          estimatedTime: 5,
          impact: t(
            "dashboard-main:dashboard.strategicSummary.impact.familyProtection",
          ),
          whyImportant: t(
            "dashboard-main:dashboard.strategicSummary.whyImportant",
          ),
          whatHappensIfNot: t(
            "dashboard-main:dashboard.strategicSummary.ifNotDone",
          ),
          priority: "critical",
        },
        {
          id: "guardian-network",
          title: t("dashboard-main:dashboard.strategicSummary.guardianNetwork"),
          description: t(
            "dashboard-main:dashboard.strategicSummary.guardianNetworkDesc",
          ),
          ...
          nextAction:
            guardians.length === 0
              ? t(
                  "dashboard-main:dashboard.strategicSummary.addPrimaryGuardian",
                )
              : t(
                  "dashboard-main:dashboard.strategicSummary.addBackupGuardian",
                ),
          estimatedTime: 8,
          impact: t(
            "dashboard-main:dashboard.strategicSummary.impact.immediateDecision",
          ),
          whyImportant: t(
            "dashboard-main:dashboard.strategicSummary.whyImportant",
          ),
        ...
        {
          id: "asset-inventory",
          title: t("dashboard-main:dashboard.strategicSummary.assetInventory"),
          description: t(
            "dashboard-main:dashboard.strategicSummary.assetInventoryDesc",
          ),
          icon: <Building className="h-5 w-5" />,
          completed: assets.length >= 3,
          nextAction:
            assets.length === 0
              ? t("dashboard-main:dashboard.strategicSummary.addHomeProperty")
              : t(
                  "dashboard-main:dashboard.strategicSummary.addFinancialAccounts",
                ),
          estimatedTime: 10,
          impact: t(
            "dashboard-main:dashboard.strategicSummary.impact.preventsAssetLoss",
          ),
          whyImportant: t(
            "dashboard-main:dashboard.strategicSummary.whyImportant",
          ),
        ...
        {
          id: "inheritance-plan",
          title: t("dashboard-main:dashboard.strategicSummary.inheritancePlan"),
          description: t(
            "dashboard-main:dashboard.strategicSummary.inheritancePlanDesc",
          ),
          ...
          nextAction:
            beneficiaries.length === 0
              ? t(
                  "dashboard-main:dashboard.strategicSummary.addPrimaryBeneficiary",
                )
              : t(
                  "dashboard-main:dashboard.strategicSummary.addContingentBeneficiaries",
                ),
          estimatedTime: 6,
          impact: t(
            "dashboard-main:dashboard.strategicSummary.impact.preventsConflicts",
          ),
          whyImportant: t(
            "dashboard-main:dashboard.strategicSummary.whyImportant",
          ),
      ...
      const criticalIncomplete = areas.filter(
        (area) => !area.completed && area.priority === "critical",
      );
  ...
  const getNextDocumentAction = (
    documents: Array<Record<string, unknown>>,
  ): string => {
    const criticalDocs = documents.filter(
      (d) => d.importance_level === "critical",
    );
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-blue-800">
                  {t("dashboard.strategicSummary.nextCriticalStep")}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-blue-600">
                ...
                <span>
                  {t("dashboard.strategicSummary.minutes", { count: 3 })}
                </span>
              </div>
            </div>
          )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                    ...
                    <div className="p-3 bg-orange-50 rounded-lg">
                      ...
                      <p className="text-orange-700 text-xs">
                        {area.whatHappensIfNot}
                      </p>
                    </div>
                    <div className="p-3 bg-green-50 rounded-lg">
                      <div className="font-medium text-green-800 mb-1">
                        {t("dashboard.strategicSummary.nextAction")}
                      </div>
