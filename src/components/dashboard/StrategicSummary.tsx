    ...
    (
      ...
      const areas: StrategicArea[] = [
        ...
        },
        {
          ...
          nextAction:
            guardians.length === 0
              ? t("dashboard.strategicSummary.addPrimaryGuardian")
              : t("dashboard.strategicSummary.addBackupGuardian"),
          estimatedTime: 8,
        ...
        },
        {
          ...
          nextAction:
            assets.length === 0
              ? t("dashboard.strategicSummary.addHomeProperty")
              : t("dashboard.strategicSummary.addFinancialAccounts"),
          estimatedTime: 10,
        ...
        },
        {
          ...
          nextAction:
            beneficiaries.length === 0
              ? t("dashboard.strategicSummary.addPrimaryBeneficiary")
              : t("dashboard.strategicSummary.addContingentBeneficiaries"),
          estimatedTime: 6,
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <div className="font-medium text-blue-800 mb-1">
                        {t("dashboard.strategicSummary.whyImportant")}
                      </div>
                    ...
                    <div className="p-3 bg-orange-50 rounded-lg">
                      <div className="font-medium text-orange-800 mb-1">
                        {t("dashboard.strategicSummary.ifNotDone")}
                      </div>
