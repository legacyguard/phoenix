              ...
              <Sheet open={isGuideOpen} onOpenChange={setIsGuideOpen}>
                <SheetTrigger asChild>
                  <Button variant="outline" size="sm">
                    ...
                    {isDiscreteMode
                      ? t("dashboard-main:dashboard.familyGuide.view")
                      : t("dashboard-main:dashboard.familyGuide.generateGuide")}
                  </Button>
                </SheetTrigger>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">
                  {isDiscreteMode
                    ? t("dashboard-main:dashboard.familyGuide.discreteModeDesc")
                    : t("dashboard-main:dashboard.familyGuide.subtitle")}
                </p>
