...
import type { AsyncErrorBoundary } from "@/components/common/AsyncErrorBoundary";
import type {
  documentFormSchema,
...
export const DocumentUpload: React.FC<DocumentUploadProps> = ({
  ...
  const documentTypes = [
    ...
    {
      key: "bankStatement",
      value: t("types.bankStatement"),
      suggestContact: true,
      suggestSubscription: true,
    },
    {
      key: "investmentCertificate",
      value: t("types.certificate"),
      suggestContact: true,
    },
    {
      key: "energyContract",
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      setShowForm(true);
      toast.success(t("ui-elements:ui.uploaded"));
