  ...
  const getRecommendations = (): Recommendation[] => {
    ...
    if (completionScore < 25) {
      if (!completedItems.includes("emergency-contacts")) {
        recommendations.push({
          ...
          title: t("dashboard-main:dashboard.emergencyContacts.title"),
          description: t(
            "dashboard-main:dashboard.emergencyContacts.description",
          ),
          category: "critical",
          estimatedTime: "5 minutes",
          icon: <Users className="h-5 w-5" />,
          actionUrl: "/manual",
          actionLabel: t("dashboard-main:dashboard.emergencyContacts.action"),
          impact: t("dashboard-main:dashboard.emergencyContacts.impact"),
        });
      }
      ...
      if (!completedItems.includes("key-documents")) {
        recommendations.push({
          ...
          title: t("dashboard-main:dashboard.keyDocuments.title"),
          description: t("dashboard-main:dashboard.keyDocuments.description"),
          category: "critical",
          estimatedTime: "10 minutes",
          icon: <FileText className="h-5 w-5" />,
          actionUrl: "/vault",
          actionLabel: t("dashboard-main:dashboard.keyDocuments.action"),
          impact: t("dashboard-main:dashboard.keyDocuments.impact"),
        });
      }
    }
    ...
    if (completionScore >= 25 && completionScore < 60) {
      if (!completedItems.includes("asset-inventory")) {
        recommendations.push({
          ...
          title: t("dashboard-main:dashboard.assetInventory.title"),
          description: t("dashboard-main:dashboard.assetInventory.description"),
          category: "important",
          estimatedTime: "15 minutes",
          icon: <Wallet className="h-5 w-5" />,
          actionUrl: "/assets",
          actionLabel: t("dashboard-main:dashboard.assetInventory.action"),
          impact: t("dashboard-main:dashboard.assetInventory.impact"),
        });
      }
    ...
    if (completionScore >= 60 && completionScore < 75) {
      ...
      if (!completedItems.includes("access-verification")) {
        recommendations.push({
          id: "verify-access",
          title: t("dashboard-main:dashboard.accessVerification.title"),
          description: t(
            "dashboard-main:dashboard.accessVerification.description",
          ),
          category: "suggested",
          estimatedTime: "15 minutes",
          icon: <CheckCircle className="h-5 w-5" />,
          actionUrl: "/settings/security",
          actionLabel: t("dashboard-main:dashboard.accessVerification.action"),
          impact: t("dashboard-main:dashboard.accessVerification.impact"),
        });
      }
    }
    ...
    if (completionScore >= 75) {
      recommendations.push({
        id: "annual-review",
        title: t("dashboard-main:dashboard.annualReview.title"),
        description: t("dashboard-main:dashboard.annualReview.description"),
        category: "important",
        estimatedTime: "20 minutes",
        icon: <Target className="h-5 w-5" />,
        actionUrl: "/annual-review",
        actionLabel: t("dashboard-main:dashboard.annualReview.action"),
        impact: t("dashboard-main:dashboard.annualReview.impact"),
      });
    }
      ...
      case "important":
        return (
          <Badge variant="default" className="text-xs">
            {t("dashboard.priority.important")}
          </Badge>
        );
      default:
        return (
          <Badge variant="secondary" className="text-xs">
            {t("dashboard.priority.suggested")}
          </Badge>
        );
    }
  };
                  ...
                  {recommendation.prerequisites &&
                    recommendation.prerequisites.length > 0 && (
                      <Alert className="border-0 bg-yellow-50 dark:bg-yellow-950/20">
                        ...
                        <AlertDescription className="text-sm">
                          <span className="font-medium">
                            {t("dashboard.prerequisites.label")}:{" "}
                          </span>
