                  ...
                  {document.contact_person && (
                    <div className="flex items-center gap-2">
                      <span className="text-muted-foreground">
                        {t("dashboard-main:dashboard.metadata.contact")}:
                      </span>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-muted-foreground">
                            ...
                            {document.subscription_type === "monthly"
                              ? t("subscription.types.monthly").toLowerCase()
                              : t("subscription.types.yearly").toLowerCase()}
                          </span>
                        </div>
                      )}
