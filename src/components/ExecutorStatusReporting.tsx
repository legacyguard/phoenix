  ...
  const STATUS_OPTIONS = [
    {
      ...
      label: t("common:estateStatus.statuses.initialReview"),
      color: "bg-gray-500",
    },
    {
      value: "gathering_documents",
      label: t("common:estateStatus.statuses.gatheringDocuments"),
      color: "bg-blue-500",
    },
    {
      value: "probate_initiated",
      label: t("common:estateStatus.statuses.probateInitiated"),
      color: "bg-indigo-500",
    },
    {
      value: "assets_being_valued",
      label: t("common:estateStatus.statuses.assetsBeingValued"),
      color: "bg-purple-500",
    },
    {
      value: "debts_being_settled",
      label: t("common:estateStatus.statuses.debtsBeingSettled"),
      color: "bg-orange-500",
    },
    {
      value: "tax_preparation",
      label: t("common:estateStatus.statuses.taxPreparation"),
      color: "bg-yellow-500",
    },
    {
      value: "ready_for_distribution",
      label: t("common:estateStatus.statuses.readyForDistribution"),
      color: "bg-teal-500",
    },
    {
      value: "distribution_in_progress",
      label: t("common:estateStatus.statuses.distributionInProgress"),
      color: "bg-green-500",
    },
    {
      value: "estate_closed",
      label: t("common:estateStatus.statuses.estateClosed"),
      color: "bg-green-700",
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase.from("access_logs").insert({
        user_id: user?.id,
        actor: "USER",
        action: t("common:estateStatus.logAction", {
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    >
                      {loading
                        ? t("common:estateStatus.actions.updating")
                        : t("common:estateStatus.actions.update")}
                    </Button>
                  </div>
                </form>
              </DialogContent>
      ...
      <CardContent>
        {currentStatus ? (
          ...
          <Alert>
            ...
            <AlertDescription>
              {isReadOnly
                ? t("common:estateStatus.empty.readOnly")
                : t("common:estateStatus.empty.noStatus")}
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
