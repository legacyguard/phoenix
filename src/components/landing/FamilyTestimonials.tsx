...
export const FamilyTestimonials: React.FC = () => {
  ...
  const testimonials: Testimonial[] = useMemo(
    () => [
      {
        id: 1,
        name: t("common:testimonials.stories.1.name"),
        role: t("common:testimonials.stories.1.role"),
        location: t("common:testimonials.stories.1.location"),
        quote: t("common:testimonials.stories.1.quote"),
        highlight: t("common:testimonials.stories.1.highlight"),
        rating: 5,
        verified: true,
      },
      {
        id: 2,
        name: t("common:testimonials.stories.2.name"),
        role: t("common:testimonials.stories.2.role"),
        location: t("common:testimonials.stories.2.location"),
        quote: t("common:testimonials.stories.2.quote"),
        highlight: t("common:testimonials.stories.2.highlight"),
        rating: 5,
        verified: true,
      },
      {
        id: 3,
        name: t("common:testimonials.stories.3.name"),
        role: t("common:testimonials.stories.3.role"),
        location: t("common:testimonials.stories.3.location"),
        quote: t("common:testimonials.stories.3.quote"),
        highlight: t("common:testimonials.stories.3.highlight"),
        rating: 5,
        verified: true,
      },
    ],
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-12">
          ...
          <div className="text-center p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              {t("testimonials.stats.stressReductionLabel")}
            </p>
          </div>
          <div className="text-center p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              {t("testimonials.stats.timeSavedLabel")}
            </p>
          </div>
        </div>
