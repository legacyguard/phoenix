...
export const FamilyPreparednessCalculator: React.FC = () => {
  ...
  const handleShare = () => {
    ...
    const shareText = t("common:calculator.shareText", {
      timeSaved: timeSaved.toString(),
      moneySaved: moneySaved.toLocaleString("en-EU"),
    });
    if (navigator.share) {
      navigator.share({
        title: t("dashboard-main:dashboard.shareTitle"),
        text: shareText,
      ...
      alert(t("dashboard-main:dashboard.shareCopied"));
    }
  };
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <Heart className="h-5 w-5 text-primary" />
                  <h3 className="font-semibold text-lg">
                    {t("dashboard.results.emotional.title")}
                  </h3>
                </div>
                <div className="space-y-3 pl-7">
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-muted-foreground">
                        {t("dashboard.results.emotional.stress")}
                      </span>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-muted-foreground">
                        {t("dashboard.results.emotional.confidence")}
                      </span>
                      <span className="text-sm font-medium">
                        {confidenceIncrease}%
                      </span>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-muted-foreground">
                        {t("dashboard.results.emotional.peace")}
                      </span>
                      <span className="text-sm font-medium">
                        {controlRating}
