...
export function NotificationSettings() {
      ...
      if (permission === "granted") {
        ...
        if (subscription) {
          ...
          await pushNotifications.showLocalNotification(
            t("common:ui.testNotification"),
            {
              body: t("common:ui.testNotification"),
  ...
  const handlePreferenceChange = (key: keyof NotificationPreferences) => {
    ...
    toast.success(t("common:notifications_system.notificationsSaved"));
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {isEnabled && (
        <Card>
          <CardHeader>
            <CardTitle>{t("common:ui.testNotification")}</CardTitle>
            <CardDescription>{t("common:ui.testNotification")}</CardDescription>
          </CardHeader>
          <CardContent>
            <Button
              variant="outline"
              onClick={async () => {
                try {
                  ...
                  toast.success(
                    t("common:notifications_system.notificationsSaved"),
                  );
                } catch (error) {
                  toast.error(t("errors:errors.savingSettings"));
                }
