...
import { Lock, Shield, Home, Key, Server, Eye } from 'lucide-react';import { useTranslation } from "react-i18next";
...
const SecurityStatus: React.FC = () => {
  ...
  },
  {
    ...
    familyBenefit: t("securityStatus.familyBenefits.multiFactorAuthentication")
  },
  {
  ...
  },
  {
    ...
    familyBenefit: t("securityStatus.familyBenefits.zeroKnowledgeArchitecture")
  }];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        <Card key={index} className="flex flex-col hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent className="flex-grow space-y-3">
              <p className="text-sm text-gray-700 leading-relaxed">{feature.explanation}</p>
              <div className="bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400">
                <p className="text-sm text-gray-600 italic">"{feature.analogy}"</p>
              </div>
            </CardContent>
