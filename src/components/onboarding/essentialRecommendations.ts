...
export function generatePersonalizedPlan(
  ...
  if (
    answers.documentStatus === "not_started" ||
    answers.documentStatus === "scattered"
  ) {
    recommendations.push({
      ...
      link: "/vault",
      reason:
        "Creating a central, secure location for documents is the foundation of family preparedness.",
    });
    ...
    recommendations.push({
      ...
      description:
        "You've made a great start. Let's fill in the gaps and ensure nothing important is missing.",
      priority: "high",
      category: "document",
      estimatedTime: "20-30 minutes",
      link: "/vault",
      reason:
        "Completing your document organization ensures your family has everything they need.",
    });
  ...
  if (answers.familyStructure === "young_children") {
    recommendations.push({
      ...
      description:
        "Ensure your children will be cared for by people you trust. This is one of the most important decisions you can make.",
      priority: "immediate",
      category: "family",
      estimatedTime: "15-20 minutes",
      link: "/guardians",
      reason:
        "Young children need designated guardians who can step in immediately if needed.",
    });
    ...
    recommendations.push({
      ...
      description:
        "With a blended family, clear instructions prevent confusion and ensure everyone is treated according to your wishes.",
      priority: "high",
      category: "family",
      estimatedTime: "30-40 minutes",
      link: "/instructions",
      reason:
        "Blended families benefit from extra clarity to prevent misunderstandings.",
    });
    ...
    recommendations.push({
      ...
      description:
        "Ensure care and support flows smoothly between generations, with clear roles and responsibilities.",
      priority: "high",
      category: "planning",
      estimatedTime: "45-60 minutes",
      link: "/planning",
      reason:
        "Multi-generation families need coordinated planning to support everyone effectively.",
    });
  ...
  switch (answers.primaryConcern) {
    case "family_clarity":
      recommendations.push({
        ...
        description:
          "Give your family a clear roadmap with step-by-step instructions for any situation.",
        priority: "high",
        category: "family",
        estimatedTime: "25-35 minutes",
        link: "/playbook",
        reason:
          "Your family needs clear guidance to act confidently during difficult times.",
      });
    ...
    case "document_security":
      recommendations.push({
        ...
        description:
          "Protect your sensitive information with bank-level security while keeping it accessible to the right people.",
        priority: "immediate",
        category: "security",
        estimatedTime: "15-20 minutes",
        link: "/security",
        reason:
          "Securing your documents protects your family from identity theft and fraud.",
      });
    ...
    case "legal_validity":
      recommendations.push({
        ...
        description:
          "Ensure your wishes are legally binding with properly executed documents.",
        priority: "immediate",
        category: "legal",
        estimatedTime: "45-60 minutes",
        link: "/legal",
        reason:
          "Legal validity ensures your wishes will be honored and reduces family conflicts.",
      });
    ...
    case "emergency_access":
      recommendations.push({
        ...
        description:
          "Create a system that gives trusted people immediate access when truly needed.",
        priority: "immediate",
        category: "security",
        estimatedTime: "20-25 minutes",
        link: "/emergency",
        reason:
          "Emergency access ensures help is available when time is critical.",
      });
    ...
    case "privacy_control":
      recommendations.push({
        ...
        description:
          "You decide who sees what and when. Set up granular privacy controls for complete peace of mind.",
        priority: "high",
        category: "security",
        estimatedTime: "15-20 minutes",
        link: "/privacy",
        reason:
          "Privacy controls ensure sensitive information is only shared appropriately.",
      });
  ...
  if (
    answers.supportNetwork === "building_network" ||
    answers.supportNetwork === "family_only"
  ) {
    recommendations.push({
      id: "trusted-contacts",
      ...
      link: "/contacts",
      reason:
        "A strong support network provides multiple layers of help for your family.",
    });
  }
  ...
  switch (answers.timelinePreference) {
    ...
    case "this_year":
      timeline =
        "Take your time - we'll guide you through everything at your own pace.";
      break;
    case "just_exploring":
  ...
  if (answers.documentStatus === "not_started") {
    reassurance =
      "Starting is often the hardest part, but you've already taken that step. We'll guide you through everything.";
  } else if (
    answers.comfortLevel === "need_guidance" ||
    answers.comfortLevel === "prefer_professional"
  ) {
    reassurance =
      "You don't have to figure this out alone. We'll provide all the guidance and support you need.";
  } else if (answers.familyStructure === "young_children") {
    reassurance =
      "You're taking important steps to protect your children's future. That's what great parents do.";
  } else {
    reassurance =
      "You're on the right path to giving your family security and peace of mind.";
  }
...
export function getTaskEstimate(answers: EssentialAnswers): {
  ...
  if (
    answers.familyStructure === "blended" ||
    answers.familyStructure === "multi_generation"
  ) {
    complexity = "complex";
  } else if (
    answers.documentStatus === "not_started" ||
