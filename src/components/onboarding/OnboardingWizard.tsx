...
export const OnboardingWizard: React.FC<OnboardingWizardProps> = ({
  ...
  const generateTasks = (answers: ProjectOrderAnswers): TaskItem[] => {
    ...
    if (
      ...
      const docTitle = t(
        "dashboard-main:dashboard.tasks.documentCentralization.title",
      );
      let docDescription = t(
        "dashboard-main:dashboard.tasks.documentCentralization.description",
      );
      ...
      if (answers.documentAccess === "no") {
        tasks.push({
          id: "asset-inventory",
          title: t("dashboard-main:dashboard.tasks.assetInventory.title"),
          description: t(
            "dashboard-main:dashboard.tasks.assetInventory.description",
          ),
          priority: "high",
          pillar: "organize",
          completed: false,
    ...
    if (
      ...
      let guardianDescription = t(
        "dashboard-main:dashboard.tasks.guardianInstructions.description",
      );
      ...
      tasks.push({
        ...
        title: t("dashboard-main:dashboard.tasks.guardianInstructions.title"),
      ...
      if (answers.caretaker === "not_thought") {
        tasks.push({
          ...
          title: t("dashboard-main:dashboard.tasks.emergencyContacts.title"),
          description: t(
            "dashboard-main:dashboard.tasks.emergencyContacts.description",
          ),
          priority: "high",
          pillar: "secure",
          completed: false,
    ...
    if (
      ...
      tasks.push({
        id: "will-preparation",
        title: t("dashboard-main:dashboard.tasks.willPreparation.title"),
        description: t(
          "dashboard-main:dashboard.tasks.willPreparation.description",
        ),
        priority: "high",
        pillar: "transfer",
        completed: false,
    ...
    switch (answers.biggestWorry) {
      case "financial":
        tasks.push({
          id: "bank-account",
          title: t("dashboard-main:dashboard.tasks.bankAccount.title"),
          description: t(
            "dashboard-main:dashboard.tasks.bankAccount.description",
          ),
          priority: "high",
          pillar: "organize",
          completed: false,
      ...
      case "legal":
        tasks.push({
          ...
          title: t("dashboard-main:dashboard.tasks.inheritanceEducation.title"),
          description: t(
            "dashboard-main:dashboard.tasks.inheritanceEducation.description",
          ),
          priority: "high",
          pillar: "transfer",
          completed: false,
      ...
      case "memories":
        tasks.push({
          ...
          title: t("dashboard-main:dashboard.tasks.personalMessages.title"),
          description: t(
            "dashboard-main:dashboard.tasks.personalMessages.description",
          ),
          priority: "high",
          pillar: "transfer",
          completed: false,
      ...
      case "conflicts":
        tasks.push({
          id: "family-meeting",
          title: t("dashboard-main:dashboard.tasks.familyMeeting.title"),
          description: t(
            "dashboard-main:dashboard.tasks.familyMeeting.description",
          ),
          priority: "high",
          pillar: "transfer",
          completed: false,
    ...
    if (answers.caretaker === "not_thought") {
      tasks.push({
        ...
        title: t("dashboard-main:dashboard.tasks.digitalAssetPlan.title"),
        description: t(
          "dashboard-main:dashboard.tasks.digitalAssetPlan.description",
        ),
        priority: "medium",
        pillar: "secure",
        completed: false,
