...
const questions: LifeQuestion[] = [
{
  ...
  explanation: 'Most men in your position are the go-to person for important decisions. We want to make sure your family stays protected even when you can\'t be there to guide them.',
  ...
  options: [
  {
    ...
    description: 'I handle the major decisions and keep our household running'
  },
  {
    value: 'family_turns_to_me',
    label: 'I\'m the one my family turns to when things go wrong',
    icon: <Shield className="h-5 w-5" />,
    description: 'From emergencies to big decisions, they count on my judgment'
  },
  {
    value: 'handle_decisions',
    label: 'I handle most of the important family decisions',
    icon: <FileCheck className="h-5 w-5" />,
    description: 'Financial planning, major purchases, future planning - it\'s on me'
  },
  {
    value: 'family_would_struggle',
    label: 'My family would struggle without my guidance',
    icon: <AlertCircle className="h-5 w-5" />,
    description: 'They depend on my experience and knowledge to navigate life'
  }]
...
},
{
  ...
  explanation: 'Being prepared isn\'t just about having things—it\'s about having them organized so your family can find what they need when they need it.',
  theme: 'preparedness',
  options: [
  {
  ...
  },
  {
    ...
    description: 'Information exists but it\'s spread across different locations'
  },
  {
    value: 'need_time',
    label: 'I\'d need time to gather everything together',
    icon: <AlertCircle className="h-5 w-5" />,
    description: 'I could find what\'s needed, but it would take significant effort'
  },
  {
    value: 'not_sure',
    label: 'Honestly, I\'m not sure where everything is',
    icon: <Users className="h-5 w-5" />,
    description: 'Things have accumulated over the years without much organization'
  }]
...
},
{
  ...
  explanation: 'Every family has that one area where they\'d struggle most. Knowing this helps us focus on what matters most to your family\'s security.',
  theme: 'protection',
  options: [
  {
    ...
    icon: <FileCheck className="h-5 w-5" />,
    description: 'They wouldn\'t know where to look or how to access critical accounts'
  },
  {
    value: 'contacts_actions',
    label: 'Knowing who to contact and what to do',
    icon: <Users className="h-5 w-5" />,
    description: 'The network of professionals and steps to take in various situations'
  },
  {
    value: 'financial_situation',
    label: 'Understanding our financial situation',
    icon: <TrendingUp className="h-5 w-5" />,
    description: 'Accounts, investments, debts, and ongoing financial obligations'
  },
  {
    value: 'decisions_i_handle',
    label: 'Making decisions I usually handle',
    icon: <Shield className="h-5 w-5" />,
    description: 'From daily operations to major life choices I typically manage'
  }]
...
},
{
  ...
  explanation: 'Your responsibilities shape what kind of preparation you need. A business owner has different needs than someone caring for elderly parents.',
  theme: 'control',
  options: [
  {
    ...
    icon: <Shield className="h-5 w-5" />,
    description: 'Ensuring they\'re financially protected and prepared for the future'
  },
  {
