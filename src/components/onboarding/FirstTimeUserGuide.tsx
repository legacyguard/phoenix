  ...
  const guideSteps = [
    {
      ...
      title: t(
        "onboarding:firstTimeGuide.step1.title",
        "Welcome to Your Heritage Vault",
      ),
      description: t(
        "onboarding:firstTimeGuide.step1.description",
      ...
      details: [
        t(
          "onboarding:firstTimeGuide.step1.detail1",
          "Your data stays private - we never sell or share your information",
        ),
        t(
          "onboarding:firstTimeGuide.step1.detail2",
          "Everything is encrypted and stored securely",
        ),
        t(
          "onboarding:firstTimeGuide.step1.detail3",
    ...
    },
    {
      ...
      title: t(
        "onboarding:firstTimeGuide.step2.title",
        "Your Three Main Areas",
      ),
      description: t(
        "onboarding:firstTimeGuide.step2.description",
        "LegacyGuard is organized around three simple areas that cover everything your family needs to know.",
      ),
      details: [
        t(
          "onboarding:firstTimeGuide.step2.detail1",
          "Vault: Store your important documents and asset information",
        ),
        t(
          "onboarding:firstTimeGuide.step2.detail2",
          "Trusted Circle: Designate people who will help your family",
        ),
        t(
          "onboarding:firstTimeGuide.step2.detail3",
