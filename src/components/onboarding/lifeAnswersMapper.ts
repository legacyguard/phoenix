 ...
 */
export function mapLifeAnswersToProjectOrder(lifeAnswers: LifeAnswers): ProjectOrderAnswers {
 ...
 */
export function mapProjectOrderToLifeAnswers(projectAnswers: ProjectOrderAnswers): Partial<LifeAnswers> {
