  ...
  return (
    <div className="p-6 font-sans max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800">
        {t("ui-elements:ui.title")}
      </h2>
      <p className="text-gray-600 mt-1">{t("ui-elements:ui.subtitle")}</p>
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {t("dataManagement.dataRetention")}
            </p>
            <Select
              value={(userSettings.autoDeleteAfter ?? 0).toString()}
              onValueChange={(value) =>
                handleSettingChange("autoDeleteAfter", parseInt(value))
              }
            >
              <SelectTrigger>
                <SelectValue />
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={
                userSettings.aiFeatureToggles?.expirationIntelligence ?? true
              }
              onCheckedChange={(checked) =>
                handleSettingChange(
                  "aiFeatureToggles.expirationIntelligence",
                  checked,
                )
              }
            />
      ...
      <Card className="mt-6 opacity-50">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-500">
            {t("dataManagement.privacySettings")}
          </p>
        </CardContent>
      </Card>
