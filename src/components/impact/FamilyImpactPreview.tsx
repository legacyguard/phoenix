...
const generateImpactScenarios = (userActions: UserAction[]): ImpactScenario[] => {
      ...
      switch (action.type) {
        case 'asset':
          scenarios.push({
            ...
            currentBenefit: 'Your family can find your bank account information in 5 minutes instead of searching for weeks',
            timeAndStressSaved: 'This saves your family approximately 40 hours of searching and calling',
            realWorldScenario: 'When your family needs to pay bills, they\'ll know which account to use'
          });
          break;
        case 'will':
          scenarios.push({
            ...
            currentBenefit: 'Your family knows exactly what you decided - no guessing or arguments',
            timeAndStressSaved: 'This prevents costly legal disputes and family conflicts',
            realWorldScenario: 'Your wishes are documented and legally clear to everyone'
          });
          break;
        case 'trustedCircle':
          scenarios.push({
            ...
            currentBenefit: 'Your family has specific people to call who know how to help',
            timeAndStressSaved: 'This eliminates the stress of making decisions alone during difficult times',
            realWorldScenario: 'When your family needs legal help, they\'ll know which attorney to call'
          });
          break;
      }
    }
...
const ImpactScenario: React.FC<{ scenario: ImpactScenario }> = ({ scenario }) => (
...
const FamilyImpactPreview: React.FC<{ userActions: UserAction[] }> = ({ userActions }) => {
  ...
  const undocumentedActions = userActions.filter(action => !action.documented);
          ...
          <div className="undocumented-impacts">
            {undocumentedActions.map(action => (
              <div key={action.id} className="potential-impact">
                <p>By documenting {action.description}, your family would benefit from:</p>
      ...
      <div className="documentation-comparison">
        ...
        <div className="comparison-grid">
          <div className="without-documentation">
            ...
            <ul>
              <li>Your family searches through papers and calls multiple institutions</li>
              <li>Important deadlines might be missed</li>
              <li>Family members may disagree about your wishes</li>
              <li>Expensive professionals may need to be hired to find information</li>
            </ul>
          </div>
          <div className="with-documentation">
            ...
            <ul>
              {documentedActions.length > 0 ? (
                <>
                  <li>Your family has immediate access to documented information</li>
                ...
                <li>Start documenting to provide these benefits to your family</li>
              )}
            </ul>
          </div>
        </div>
    ...
    case 'medical':
      return (
        <ul>
          ...
          <li>Family members wouldn't have to guess during medical emergencies</li>
        </ul>
      );
    case 'trustedCircle':
      return (
