...
export const WhatIfScenarios: React.FC<WhatIfScenariosProps> = ({
  ...
  const scenarios: Scenario[] = useMemo(
    () => [
      {
        id: "hospital_stay",
        title: t("common:whatIfScenarios.hospitalStay.title"),
        duration: "2-4 weeks",
        ...
        impact: t("common:whatIfScenarios.hospitalStay.impact"),
        readiness: 82,
      ...
      {
        id: "business_travel",
        title: t("common:whatIfScenarios.businessTravel.title"),
        duration: "2-3 months",
        needs: [
        ...
        impact: t("common:whatIfScenarios.businessTravel.impact"),
        readiness: 75,
      ...
      {
        id: "sudden_death",
        title: t("common:whatIfScenarios.suddenDeath.title"),
        ...
        impact: t("common:whatIfScenarios.suddenDeath.impact"),
        readiness: 60,
      ...
      },
      {
        ...
        title: t("common:whatIfScenarios.disabilityIncapacity.title"),
        ...
        impact: t("common:whatIfScenarios.disabilityIncapacity.impact"),
        readiness: 68,
      ...
      {scenarios.map((scenario) => (
        <Card key={scenario.id} className="border">
          <CardHeader className="pb-4 flex items-center space-x-3">
            <div className="p-2 bg-muted rounded-lg">{scenario.icon}</div>
          ...
          <CardContent>
            <div className="space-y-2">
              <p>
                {t("whatIfScenarios.duration", { duration: scenario.duration })}
              </p>
              <p>
                {t("whatIfScenarios.needs", {
                  needs: scenario.needs.join(", "),
                })}
              </p>
              <p>
                {t("whatIfScenarios.requirements", {
                  requirements: scenario.requirements.join(", "),
                })}
              </p>
              <p className="text-orange-600">
                {t("whatIfScenarios.missing", {
