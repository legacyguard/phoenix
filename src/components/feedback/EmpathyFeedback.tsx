...
const EmpathyFeedback: React.FC<EmpathyFeedbackProps> = ({
  ...
  const handleSubmit = () => {
    ...
    trackEmpatheticInteraction({
      ...
      emotionalTone:
        feedbackData.overallExperienceScore >= 7
          ? "positive"
          : feedbackData.overallExperienceScore >= 4
            ? "neutral"
            : "negative",
        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Your feedback helps us create a more caring experience for
              families like yours.
            </p>
          </div>
        </CardContent>
    ...
    <Card className="max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex justify-between">
          ...
          {currentQuestion === questions.length - 1 ? (
            <Button onClick={handleSubmit} disabled={!responses[currentQ.id]}>
              Submit Feedback
            </Button>
          ) : (
            <Button
              onClick={() =>
                handleResponse(responses[currentQ.id]?.toString() || "5")
              }
