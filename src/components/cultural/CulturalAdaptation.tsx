...
const culturalOptions: CulturalOption[] = [
  // Religious Considerations
  {
    ...
    description:
      "Follow Sharia-compliant distribution guidelines while meeting legal requirements",
    category: "religious",
    details:
      "We can help structure your planning to honor Islamic inheritance principles while ensuring legal validity in your jurisdiction.",
  },
  {
    ...
    category: "religious",
    details:
      "Include ethical wills (tzava'ah) and honor traditions around inheritance and family obligations.",
  },
  {
    id: "christian_values",
    ...
    category: "religious",
    details:
      "Consider tithing, charitable giving, and values-based distribution in your planning.",
  },
  {
    ...
    category: "religious",
    details:
      "Focus on mindful giving and reducing attachment while protecting loved ones.",
  },
  ...
  // Traditional/Cultural Practices
  {
    ...
    details:
      "Ensure your planning reflects the cultural importance of caring for elders.",
  },
  {
    ...
    category: "traditional",
    details:
      "Create mechanisms for family consultation while maintaining legal clarity.",
  },
  {
    ...
    category: "traditional",
    details:
      "Structure ownership to keep important property within the family line.",
  },
  {
    id: "gender_customs",
    ...
    category: "traditional",
    details:
      "Navigate cultural expectations while ensuring fair and legal distribution.",
  },
  ...
  },
  {
    ...
    category: "family",
    details:
      "Blend different cultural expectations harmoniously in your planning.",
  },
  {
    id: "immigrant_family",
...
export const CulturalAdaptation: React.FC<CulturalAdaptationProps> = ({
  ...
  const handleSave = () => {
    const religious = culturalOptions
      .filter(
        (opt) => opt.category === "religious" && selectedOptions.has(opt.id),
      )
      .map((opt) => opt.id);

    const traditions = culturalOptions
      .filter(
        (opt) => opt.category === "traditional" && selectedOptions.has(opt.id),
      )
      .map((opt) => opt.id);
    ...
    toast({
      title: t("common:cultural.saved"),
      description: t("common:cultural.savedDesc"),
    });
      ...
      <Card>
        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription>{t("cultural.respectMessage")}</AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">
            {t("cultural.selectConsiderations")}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <ScrollArea className="h-[400px] mt-4">
              {["religious", "traditional", "family", "legal"].map(
                (category) => (
                  <TabsContent
                    key={category}
                    value={category}
