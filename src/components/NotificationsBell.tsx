...
export const NotificationsBell: React.FC = () => {
  ...
  const formatTimeAgo = (dateString: string) => {
    ...
    if (diffInHours < 1) return t("common:notifications.justNow", "Just now");
    if (diffInHours < 24)
      return t("common:notifications.hoursAgo", { hours: diffInHours });
    const diffInDays = Math.floor(diffInHours / 24);
    if (diffInDays === 1)
      return t("common:notifications.yesterday", "Yesterday");
    return t("common:notifications.daysAgo", { days: diffInDays });
  };
