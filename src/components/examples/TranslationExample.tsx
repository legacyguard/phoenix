  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              {tAssets("form.name")}: {tAssets("form.namePlaceholder")}
            </p>
            <p>
              {tAssets("form.type")}: {tAssets("form.selectType")}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            {tDocuments("management.description")}
          </p>

          <div className="flex gap-2">
            <Badge variant="outline">{tDocuments("categories.legal")}</Badge>
            <Badge variant="outline">
              {tDocuments("categories.financial")}
            </Badge>
            <Badge variant="outline">
              {tDocuments("categories.insurance")}
            </Badge>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              {tWills("form.personalInfo.fullName")}:{" "}
              {tWills("validation.nameRequired")}
            </p>
            <p>
              {tWills("form.personalInfo.dateOfBirth")}:{" "}
              {tWills("validation.dobRequired")}
            </p>
          </div>
