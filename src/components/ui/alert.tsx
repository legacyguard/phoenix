...
const alertVariants = cva(
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4",
  {
    variants: {
      variant: {
        default: "bg-background text-text-main border-secondary [\u0026>svg]:text-secondary dark:bg-dark-background dark:text-dark-text-main dark:border-dark-border [\u0026>svg]:dark:text-dark-secondary",
        destructive:
