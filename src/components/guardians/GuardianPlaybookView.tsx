...
export default function GuardianPlaybookView({
  ...
  const fetchPlaybook = useCallback(async () => {
    try {
      ...
      if (!user) {
        toast.error(t("common:family.notAuthenticated"));
        return;
      }
      ...
      if (guardianError || !guardianData) {
        toast.error(t("common:family.accessDenied"));
        return;
      }
      ...
      toast.error(t("common:family.fetchError"));
    } finally {
      setLoading(false);
    }
  }, [guardianId, t]);
  ...
  const sections = [
    {
      id: "funeral",
      icon: Heart,
      title: t("common:family.tabs.funeral"),
    ...
    },
    {
      id: "digital",
      icon: Shield,
      title: t("common:family.tabs.digital"),
    ...
    },
    {
      id: "documents",
      icon: FileText,
      title: t("common:family.tabs.documents"),
    ...
    },
    {
      id: "messages",
      icon: MessageSquare,
      title: t("common:family.tabs.messages"),
    ...
    },
    {
      id: "instructions",
      icon: Home,
      title: t("common:family.tabs.instructions"),
