      ...
      FallbackComponent={({ error, resetErrorBoundary }) => (
        <div className="empathetic-error-boundary">
          ...
          <div className="error-explanation">
            <p>
              This kind of thing happens sometimes with technology. It's not
              your fault, and it doesn't mean anything is wrong with your
              planning.
            </p>
          </div>
          ...
          <div className="reassurance">
            <p>
              Remember: You're doing something really important for your family.
              Don't let a technical hiccup stop you.
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              {t("recovery.data_secure")}
            </p>
          </div>
        </div>
      )}
