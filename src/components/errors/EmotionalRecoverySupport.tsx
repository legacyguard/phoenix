...
const EmotionalRecoverySupport: React.FC<EmotionalRecoverySupportProps> = ({
  ...
  const getEmotionalSupport = () => {
    switch (errorType) {
      case "timeout":
      case "network":
        return t("errors:emotional_support.time_pressure");
      case "validation":
        return t("errors:emotional_support.frustration");
      case "save_failed":
        return t("errors:emotional_support.overwhelm");
      default:
        return t("errors:emotional_support.discouragement");
    }
  };
    ...
    <Card className="emotional-recovery p-6 max-w-2xl mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Technical issues are frustrating, especially when you're working on
          something so important for your family.
        </p>
      </div>

      <div className="recovery-encouragement bg-blue-50 rounded-lg p-4 mb-6">
        <p className="text-blue-900">{getEmotionalSupport()}</p>
      ...
      <div className="next-steps">
        <p className="text-gray-600 mb-4">
          When you're ready, I'm here to help you continue. We'll get through
          this together.
        </p>
