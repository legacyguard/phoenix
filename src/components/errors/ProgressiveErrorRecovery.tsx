...
const ProgressiveErrorRecovery: React.FC<ProgressiveErrorRecoveryProps> = ({
  ...
  useEffect(() => {
    if (retryCount === 0) {
      ...
      setRecoveryMessage(t("errors:general.try_again"));
    } else if (retryCount < maxRetries) {
      setCurrentLevel("alternative");
      setRecoveryMessage(t("errors:solutions.alternative_approach"));
    } else {
      setCurrentLevel("support");
      setRecoveryMessage(t("errors:solutions.contact_support"));
    }
