...
const AssetOverview = React.lazy(() => import("./features/assets-vault/components/AssetOverview").then(m => ({ default: m.AssetOverview })));
const SubscriptionDashboard = React.lazy(() => import("./features/subscriptions/components/SubscriptionDashboard").then(m => ({ default: m.SubscriptionDashboard })));
...
const Vault = React.lazy(() => import("./features/assets-vault/components/VaultDashboard").then(m => ({ default: m.Vault })));
const TrustedCircle = React.lazy(() => import("./features/family-circle/components/TrustedCircle"));
const FamilyHub = React.lazy(() => import("./features/family-circle/components/FamilyHub"));
