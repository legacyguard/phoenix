...
export function useAI(): UseAIReturn {
  ...
  const [suggestionError, setSuggestionError] = useState<OpenAIError | null>(
    null,
  );
  ...
  const generateQuestionMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await openAIService.generateLifeQuestion(
        profile,
        options,
      );
  ...
  const extractMetadataMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await openAIService.extractDocumentMetadata(
        text,
        docType,
        options,
      );
  ...
  const generateMessageMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await openAIService.generateEmpatheticMessage(
        scenario,
        tone,
      );
  ...
  const suggestAction = useCallback(
    async (
      ...
      try {
        ...
        const result = await suggestActionMutation.mutateAsync({
          context,
          options,
        });
        return result || null;
  ...
  const extractMetadata = useCallback(
    async (
      ...
      try {
        ...
        const result = await extractMetadataMutation.mutateAsync({
          text,
          docType,
          options,
        });
...
export function useLifeQuestions(
