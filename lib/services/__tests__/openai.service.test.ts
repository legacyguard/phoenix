...
describe('OpenAI Service', () => {
  ...
  describe('Action Suggestions', () => {
    it('should suggest next actions based on context', async () => {
      ...
      const mockSuggestion = {
        ...
        reason: 'You\'ve made great progress with your will. Adding insurance documents will help protect your family\'s financial future.',
        priority: 'soon' as const,
        estimatedTime: '10 minutes',
        encouragement: 'You\'re doing wonderfully! Each document you add brings more peace of mind.',
      };
  ...
  describe('Empathetic Message Generation', () => {
    it('should generate supportive messages', async () => {
      ...
      const mockResponse = {
        choices: [{
          message: {
            content: 'Congratulations on completing your will! This is a profound act of love for your family. You\'ve taken an important step in protecting those you care about most.',
          },
        }],
        usage: {
          prompt_tokens: 50,
      ...
      const result = await openAIService.generateEmpatheticMessage(scenario, tone);
  ...
  describe('Token Usage and Cost Calculation', () => {
    it('should calculate costs correctly', async () => {
      ...
      const result = await openAIService.generateEmpatheticMessage('test scenario');
