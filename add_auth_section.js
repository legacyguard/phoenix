...
const authTranslations = {
  sl: {
    ...
    protectedApplicationDesc:
      "Ta aplikacija je zaščitena z geslom. Prosimo, vnesite geslo za nadaljevanje.",
    password: "Geslo",
  ...
  pl: {
    ...
    protectedApplicationDesc:
      "Ta aplikacja jest chroniona hasłem. Proszę wprowadzić hasło, aby kontynuować.",
    password: "Hasło",
  ...
  sq: {
    ...
    protectedApplicationDesc:
      "Ky aplikacion është i mbrojtur me fjalëkalim. Ju lutemi vendosni fjalëkalimin për të vazhduar.",
    password: "Fjalëkalim",
  ...
  sv: {
    ...
    protectedApplicationDesc:
      "Denna applikation är lösenordsskyddad. Ange lösenord för att fortsätta.",
    password: "Lösenord",
  ...
  ga: {
    ...
    protectedApplicationDesc:
      "Tá an feidhmchlár seo cosanta le pasfhocal. Cuir isteach an pasfhocal le leanúint ar aghaidh.",
    password: "Pasfhocal",
  ...
  mt: {
    ...
    protectedApplicationDesc:
      "Din l-applikazzjoni hija protetta b'password. Jekk jogħġbok daħħal il-password biex tkompli.",
    password: "Password",
  ...
  da: {
    ...
    protectedApplicationDesc:
      "Denne applikation er beskyttet med adgangskode. Indtast venligst adgangskoden for at fortsætte.",
  ...
  no: {
    ...
    protectedApplicationDesc:
      "Denne applikasjonen er beskyttet med passord. Vennligst skriv inn passordet for å fortsette.",
    password: "Passord",
  ...
  el: {
    ...
    protectedApplicationDesc:
      "Αυτή η εφαρμογή προστατεύεται με κωδικό πρόσβασης. Παρακαλώ εισάγετε τον κωδικό πρόσβασης για να συνεχίσετε.",
  ...
  lv: {
    ...
    protectedApplicationDesc:
      "Šī lietotne ir aizsargāta ar paroli. Lūdzu, ievadiet paroli, lai turpinātu.",
    password: "Parole",
  ...
  it: {
    ...
    protectedApplicationDesc:
      "Questa applicazione è protetta da password. Inserisci la password per continuare.",
    password: "Password",
  ...
  is: {
    ...
    protectedApplicationDesc:
      "Þetta forrit er varið með lykilorði. Vinsamlegast sláðu inn lykilorðið til að halda áfram.",
    password: "Lykilorð",
  ...
  ru: {
    ...
    protectedApplicationDesc:
      "Это приложение защищено паролем. Пожалуйста, введите пароль для продолжения.",
    password: "Пароль",
  ...
  pt: {
    ...
    protectedApplicationDesc:
      "Esta aplicação é protegida por senha. Por favor, digite a senha para continuar.",
    password: "Senha",
  ...
  sr: {
    ...
    protectedApplicationDesc:
      "Ova aplikacija je zaštićena lozinkom. Molimo unesite lozinku za nastavak.",
    password: "Lozinka",
  ...
  mk: {
    ...
    protectedApplicationDesc:
      "Оваа апликација е заштитена со лозинка. Ве молиме внесете ја лозинката за да продолжите.",
    password: "Лозинка",
  ...
  hu: {
    ...
    protectedApplicationDesc:
      "Ez az alkalmazás jelszóval védett. Kérjük, adja meg a jelszót a folytatáshoz.",
    password: "Jelszó",
  ...
  nl: {
    ...
    protectedApplicationDesc:
      "Deze applicatie is beveiligd met een wachtwoord. Voer het wachtwoord in om door te gaan.",
    password: "Wachtwoord",
  ...
  bg: {
    ...
    protectedApplicationDesc:
      "Това приложение е защитено с парола. Моля, въведете паролата, за да продължите.",
    password: "Парола",
  ...
  de: {
    ...
    protectedApplicationDesc:
      "Tämä sovellus on salasanalla suojattu. Syötä salasana jatkaaksesi.",
    password: "Salasana",
  ...
  fr: {
    ...
    protectedApplicationDesc:
      "Cette application est protégée par mot de passe. Veuillez saisir le mot de passe pour continuer.",
  ...
  es: {
    ...
    protectedApplicationDesc:
      "Esta aplicación está protegida con contraseña. Por favor, introduzca la contraseña para continuar.",
    password: "Contraseña",
  ...
  et: {
    ...
    protectedApplicationDesc:
      "See rakendus on parooliga kaitstud. Palun sisestage parool jätkamiseks.",
    password: "Parool",
  ...
  lt: {
    ...
    protectedApplicationDesc:
      "Ši programa apsaugota slaptažodžiu. Įveskite slaptažodį, kad tęstumėte.",
  ...
  cy: {
    ...
    protectedApplicationDesc:
      "Mae'r cais hwn wedi'i ddiogelu â chyfrinair. Rhowch y cyfrinair i barhau.",
    password: "Cyfrinair",
  ...
  tr: {
    ...
    protectedApplicationDesc:
      "Bu uygulama şifre ile korunmaktadır. Devam etmek için lütfen şifreyi girin.",
    password: "Şifre",
